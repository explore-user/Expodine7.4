    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="loyalty_mgmt_head"><div class="">
                    ...
                    <a   class="inv-req-btn1"  href="wastage.php">BACK</a>
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">WASTAGE HISTORY</a>
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
        ...
        var data="set=load_transfer_wastage&id=&fromdt=&todt=&staff=&search_id=&store="
             $.ajax({
        type: "POST",
    ...
    for(w=1;w<=m;w++)
     ...
     var staff=$('#staff').val();
      ...
      var search_id=$('#search_id').val();
       ...
       var store=$('#store').val();
              ...
              var data="set=load_transfer_wastage&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&search_id="+search_id+"&store="+store
      ...
      function phy_items(id){
        ...
        $('.item_pop').show();
         ...
         var data="set=load_transfer_wastage_items&id="+id
     ...
     function return_to_central(id){
        ...
        if($('#ret_reason').val()!=''){
         ...
         var reason=$('#ret_reason').val();
        
         var data="set=load_wastage_to_central&id="+id+"&reason="+reason
        ...
        success: function(data)
        {
           ...
           location.reload();
            ...
            alert('ENTER REMARKS FOR RETURN TO CENTRAL');
        }
         
         
     }
     
    function phy_items1(id){
 ...
 function search_history(){
   ...
   var staff=$('#staff').val();
    ...
    var search_id=$('#search_id').val();
              ...
              var data="set=load_transfer_wastage&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&search_id="+search_id+"&store="+store
