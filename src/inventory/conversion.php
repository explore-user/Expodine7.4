    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="loyalty_mgmt_head"><div class="">
                ...
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">CONVERSION HISTORY</a>
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
        ...
        var data="set=load_conversion&id=&fromdt=&todt=&staff=&search_id="
             $.ajax({
        type: "POST",
    ...
    for(w=1;w<=m;w++)
     ...
     var staff=$('#staff').val();
      ...
      var search_id=$('#search_id').val();
              ...
              var data="set=load_conversion&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&search_id="+search_id
 ...
 function search_history(){
   ...
   var staff=$('#staff').val();
    ...
    var search_id=$('#search_id').val();
              ...
              var data="set=load_conversion&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&search_id="+search_id
