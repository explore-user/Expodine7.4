...
<head>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <!-- Top Bar End -->
            <div class="loyalty_mgmt_head"><div class=""><span classs="" style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient(223deg, #ffffff, #ffffff)!important;padding: 0.7rem;">RETURN  HISTORY</span> </div></div>
...
<div class="inv-req-history" >
  ...
  <div class="history-filter">
      ...
      <input onkeyup="search_history();" placeholder="Search GRN ID" id="grn_id"   type="text" style=""> 
      ...
      <input autocomplete="off" onchange="search_history();" placeholder="To" id="datepicker1" type="text" style=""> 
       ...
       <select onchange="search_history();"  id="supplier" >
  ...
  <span id="load_error" style="color:darkred;font-size: 10px;float: right;margin-right:77px;margin-top: 0px;font-weight: bold" ></span>
  </div>
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
       ...
       var type=$('#type').val(); 
        var data="set=load_history_return&id=&type="+type+"&fromdt=&todt=&status_search=All&supplier=&grn_id=&staff="
             $.ajax({
        type: "POST",
    ...
    function pagination(p,q)
 {
    ...
    for(w=1;w<=m;w++)
     ...
     var grn_id=$('#grn_id').val();
              ...
              var data="set=load_history_return&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&status_search="+status_search+"&supplier="+supplier+"&staff="+staff+"&grn_id="+grn_id
 ...
 function search_history(){
   ...
   var status_search=$('#status_search').val();
    ...
    var supplier=$('#supplier').val();
     ...
     var grn_id=$('#grn_id').val();
              ...
              var data="set=load_history_return&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&status_search="+status_search+"&supplier="+supplier+"&staff="+staff+"&grn_id="+grn_id
  ...
  function return_details(id,sup){ 
        
      $(".approve_pop").show();
    
      var data1="set=purchase_return_detail&id="+id+"&sup="+sup
     $.ajax({
        type: "POST",
        url: "load_inventory.php",
        data: data1,
