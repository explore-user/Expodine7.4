    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="loyalty_mgmt_head"><div class="">
                    ...
                    <a   class="inv-req-btn1"  href="store_transfer.php">BACK</a>
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">TRANSFER HISTORY</a>
...
<div class="inv-req-history" >
 <span id="load_error" style="color:darkred;font-size: 10px;float: right;margin-right:77px;margin-top: -25px;font-weight: bold" ></span>
  ...
  <div class="history-filter">
      ...
      <input autocomplete="off" onchange="search_history();" placeholder="Id" id="tran_id" type="text" style=""> 
      ...
      <input autocomplete="off" onchange="search_history();" placeholder="To" id="datepicker1" type="text" style=""> 
        ...
        <select onchange="search_history();"  id="type_transfer" style="">
      ...
      <select onchange="search_history();"  id="staff" style="">
    ...
    <?php } } ?>
      ...
      <select onchange="search_history();"  id="fromstore" style="">
       
       <option value="">From Store</option>  
       
       <?php 
    $fnct_menu = $database->mysqlQuery("select ti_name,ti_id from tbl_inv_kitchen  ");
         $num_fdtl = $database->mysqlNumRows($fnct_menu);
        if ($num_fdtl > 0) { 
              while ($result_fnctvenue = $database->mysqlFetchArray($fnct_menu))
              { 
    ...
    <?php } } ?>
      ...
      <select onchange="search_history();"  id="tostore" style="">
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
        ...
        var data="set=load_transfer&id=&fromdt=&todt=&staff=&from=&to=&type_transfer=&tran_id="
        $.ajax({
        type: "POST",
...
function accept_transfer(id){
     ...
     $('.trans_pop').show();
    var data="set=load_transfer_items&id="+id+"&mode=accept"
...
function approve_submit(id){
    ...
    var data="set=accept_normal_transfer_to_store&id="+id
...
function show_transfer(id){
    
    $('.trans_pop').show();
    var data="set=load_transfer_items&id="+id+"&mode=view"
...
function reset_inventory(){
    ...
    function pagination(p,q)
 {
    ...
    for(w=1;w<=m;w++)
     ...
     var tran_id=$('#tran_id').val();
              ...
              var data="set=load_transfer&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&type_transfer="+type_transfer+"&from="+from+"&to="+to+"&tran_id="+tran_id
 ...
 function search_history(){
   ...
   var type_transfer=$('#type_transfer').val();
        ...
        var data="set=load_transfer&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&from="+from+"&to="+to+"&type_transfer="+type_transfer+"&tran_id="+tran_id
...
<div class="quick_pop_printer_sec bill_quick_div trans_pop" style="display:none">
    <div class="quick_pop_printer" style="width: 750px; height: 550px;">

        <div id="load_store_grn"></div>
