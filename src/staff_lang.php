...
$database	= new Database();
   ...
   if(isset($_REQUEST['set'])&&($_REQUEST['set']=="cat1")){
    ...
    $querylang=$database->mysqlQuery("select s_staff_id from  tbl_language_staff where s_staff_id='".$catid1."' and s_lang_id='". $_SESSION['idrr']."'");
    $num_gen9  = mysqli_num_rows($querylang);
		  if($num_gen9)
		  {
    
   
    $querylang1=$database->mysqlQuery("update  tbl_language_staff set s_staff_first_name='".$cat1."',s_staff_last_name='".$lastname."' where s_staff_id='".$catid1."' and s_lang_id='".$_SESSION['idrr']."'");
        }else
    {
         $insertion['s_lang_id'] =  $_SESSION['idrr'];
         $insertion['s_staff_first_name'] = $cat1;
          $insertion['s_staff_id'] = $catid1;
          $insertion['s_staff_last_name'] = $lastname;
          
          $insertid = $database->insert(' tbl_language_staff', $insertion);
    }
                            ...
                            <div class="als-viewport" style="width:100% !important">
                                ...
                                <ul class="als-wrapper">
                                    ...
                                    <li class="als-item"><a href="preference_lang.php" class="new_tab_btn ">Preference</a></li>
                                     ...
                                     <li class="als-item"><a href="staff_lang.php" class="new_tab_btn active_btn_1">Staff Master</a></li>
                                    ...
                                    <table class="responstable">  
                                        <thead>
                                         <tr>
                                         	...
                                         	<th>Staff First Name-English</th>
                                                <th>Staff First Name-<span id="newlang"><?=ucfirst($lang)?> </span></th>
                                                
                                                <th>Staff Last Name-English</th>
                                                <th>Staff Last Name-<span id="newlang"><?=ucfirst($lang)?> </span></th>
                                        ...
                                        <tbody>
                                           ...
                                           <?php        
                                                     $sql_login1  =  $database->mysqlQuery("select c.ser_staffid,c.ser_firstname,ser_lastname,
(select m.s_staff_first_name from tbl_language_staff m  where m.s_staff_id = c.ser_staffid and m.s_lang_id ='".$_SESSION['idrr']."' )as name_lang,  
    (select m.s_staff_last_name from tbl_language_staff m  where m.s_staff_id = c.ser_staffid and m.s_lang_id ='".$_SESSION['idrr']."' )as last_lang 
from  tbl_staffmaster c order by c.ser_firstname"); 
                                               ...
                                               ?>   
                                                 <tr>
                                                     <td style="min-width:50px;">
                                                         <a href="#" style="display:block" class="edit_list text1" id="edtbtn<?=$result_login1['ser_staffid']?>" onclick="edit_click('<?=$result_login1['ser_staffid']?>')"  ><img src="images/edit_page.PNG"></a>
                                                         <a href="#" style="display:none" class="edit_list" id="savebtn<?=$result_login1['ser_staffid']?>" onclick="save_click('<?=$result_login1['ser_staffid']?>')"  ><img src="img/save_ico.png"></a>
                                                   </td> 

                                                   <td ><?=$result_login1['ser_firstname']?></td>
                                                   
                                               <td ><div style="display:block" id="catnameshow<?=$result_login1['ser_staffid']?>"><?=$result_login1['name_lang']?></div>
                                                   <div id="catnameedit<?=$result_login1['ser_staffid']?>" style="display:none"> <input type="text" style="text-align:left;padding-left:10px" class="language_textbx txt1" name="catnamefield" id="catnamefield<?=$result_login1['ser_staffid']?>"  > </div></td>
                                               
                                               <td ><?=$result_login1['ser_lastname']?></td>
                                                   
                                               <td ><div style="display:block" id="catnameshow1<?=$result_login1['ser_staffid']?>"><?=$result_login1['last_lang']?></div>
                                                   <div id="catnameedit1<?=$result_login1['ser_staffid']?>" style="display:none"> <input type="text" style="text-align:left;padding-left:10px" class="language_textbx txt1" name="catnamefield1" id="catnamefield1<?=$result_login1['ser_staffid']?>"  > </div></td>
                                                 </tr>
                                <?php } } ?>
...
function changeof(){
  ...
  function edit_click(a){
     ...
     var show11=$('#catnameshow1'+a).html();
   ...
   function save_click(b){
     ...
     var lastname=$('#catnamefield1'+b).val();
     ...
     var catsh=$('#catnameshow'+b).html();
       ...
       var datastringnew="set=cat1&item1="+fitem+"&idofcat="+b+"&last="+last;
