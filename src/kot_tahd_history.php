...
.bill_history_orderd_cont{margin-top:0;width: 100%;min-height: 370px;height: 72vh;}
...
$(function() {
 ...
 /*************************************** cancel close click starts ******************************************************************  */
   $('.update_billdetails').click(function () {//alert("hi");
  ...
  $('#kotcancel_reason_popup_new_proceed_btnbh').click(function () {
      var bill=$(this).attr('billnum');
		...
		function(data)
		{
                    ...
                    $('.kotcancel_reason_popup_reprint').css('display','none');
...
function ta_reprint_kot(bill,kot){
    $('#kotcancel_reason_popup_new_proceed_btnbh').attr('billnum',bill);
     $('#kotcancel_reason_popup_new_proceed_btnbh').attr('kotno',kot);
 ...
 if(per=='Y'){
     ...
     if(reprint_code=='Y'){
     $('.kotcancel_reason_popup_reprint').css('display','block');
...
<body>
<!--    <div class="confrmation_overlay" style="display:none"></div>-->
   <div class="kotcancel_reason_popup_new kotcancel_reason_popup_reprint" style="display:none">
      ...
      <div style="width:100%" class="top_site_map_cc ">
                ...
                <!--<a href="payment_pending.php"><div class="bill_his_back_btn">Back</div></a>-->
                 ...
                 <?php include"includes/new_right_menu.php"; ?> 
                   <div class="bill_history_head"><?=$_SESSION['kot_history_kothistory']?> - TA_HD</div>
      		...
      		<div style="  min-height:480px;width:100%" class="left_contant_container">
                ...
                <div class="left_bill_history_contain">
                   ...
                   <div style="float:left;    width: 20%;display:block"><?=$_SESSION['kot_history_kot']?>
                    <input  type="text" id="kotno" name="kotno" style="color:#333;width: 50%;height: 30px;margin-left: 2%;" Onkeyup="searchkot_history('TA')">
                   ...
                   <input  type="text" id="bilno" name="bilno" style="color:#333;width: 70%;height: 30px;margin-left: 2%;" Onkeyup="searchkot_history('TA')">
                   <!-- <select  class="add_text_box filte_new_box"  id="statuss" name="statuss" onChange="validateSearch()" style="color: black;">
                                <option value="null">All</option>
                                <option value="Active">Active</option>
                                <option value="Non Active">Non-Active</option>
                   ...
                   <select  class="add_text_box filte_new_box"  id="bilsts" name="bilsts"  style="color: black;float: left;width: 60%;margin-top: 4px;" onChange="searchkot_history()">
                    ...
                    <span id='kot_reprint_status' style="color:red"></span>
                    </div>
