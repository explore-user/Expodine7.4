 ...
 <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            <button type="button" class="navbar-toggle pull-left animated flip">
                ...
                <a href="#" id="trigger" class="menu-trigger"></a>
                 ...
                 <a title="<?=$_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF']?>"  style="margin-top: 2px !important;margin-left: 0px !important;left: 0 !important;" class="navbar-brand header_logo" href="../index.php"> <img alt=""  src="img/logo20.png"  class="hidden-xs logo_cc"/></a>
	...
	<?php //include "includes/page_shortcuts.php"; ?>
     ...
     <!-- <a class="new_iframe " >
              ...
              <span id="ledger_bal_checker" title="LEDGER BALANCE UPDATE"
     style="float:right;background-color: darkred;color: white;border: solid 1px;border-radius: 4px;    margin-right: 14px;
     padding: 4px;margin-top: 8px;cursor: pointer"><i class="fa fa-file-text-o"></i></span>                          
          ...
          height: 300px;border: 3px solid #e5e5e5;border-top: 3px solid #3498db;
          border-radius: 50%;animation: spin 0.8s linear infinite;
          background: rgba(0, 0, 0, 0.6);position: fixed;top: 50%;left: 50%;
          transform: translate(-50%, -50%);z-index: 9999;display: flex;
          align-items: center;  justify-content: center;  font-size: 28px;
          font-weight: 600;  letter-spacing: 1px;   color: white; border-radius: 8px;">LEDGER UPDATED</div> </div>         
...
<div id="logout_pop" class="main_logout_popup_cc logout_main_popup_for_all">
    ...
    <div>
      <h1 class="logout_contant_txt"> LOGOUT  ?</h1>
  ...
  $(document).ready(function() {
      ...
      $("#ledger_bal_checker").click(function(e){  
