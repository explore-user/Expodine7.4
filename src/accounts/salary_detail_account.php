...
<div class="mian">
            ...
            <div class="col-md-12">
                      ...
                      <div style="margin-bottom:0;background: #fff;" class="cc_new">
                       	<div style="border: 0 !important " id="lista1" class="als-container">
                               <h3 style="float: left;margin-top: 10px;margin-left: 10px;border:solid 1px;padding: 5px;color:white;background-color: #3e1c2f">SALARY POSTING  </h3>
                               <h3 style="display:none;float: left;margin-top: 10px;margin-left: 500px;border:solid 1px;padding: 2px;color:black;"><a style="color:darkred" href="salary_edit_account.php"><img src="img/add_to.png"> SALARY HISTORY</a>  </h3>
                             ...
                             <div style="width: 120px;float: right;top: 3px;height: 33px;margin: 8px 10px;" class="search_btn_member_invoice filte_new_box_btn">
                               <a class="md-trigger"  style="background-color:#426051;margin:0;line-height: 32px;"  href="salary_edit_account.php">SALARY HISTORY</a></div>  
                      </div>
                    </div>
           </div>
                ...
                <div class="content-sec">
                	<div style="  padding: 2px;margin-top:10px;" class="col-lg-12 col-md-12 main_cc">
                        ...
                        <div class="col-md-12" style="padding:0 5px;">
                             <span style="color:darkred">[ SELECT YEAR AND MONTH FOR DETAILS ]</span>
                            <div class="ledger_head_sec" style="">  
                                ...
                                <div class="acc_add_box" style="width:48%;">
                                    <label style="margin: 0;">Month</label>
                                    <select style="background-color: #e6e6e6" class="form-control filte_new_box" id="smonth" onchange="check_data();" >
                                ...
                                <div class="acc_add_box" style="width:48%;">
                                   ...
                                   <select style="background-color: #e6e6e6" class="form-control filte_new_box" id="syear" onchange="check_data();" >
 ...
 for($starting_year; $starting_year <= $ending_year; $starting_year++) {
     ...
     echo ' >'.$starting_year.'</option>';
                                ...
                                </div><div class="acc_add_box" style="width:10%;cursor: pointer">
                                    <label style="margin: 0;">Salary</label>
                                 
                                </div><div class="acc_add_box" style="width:8%;cursor: pointer">
                                    <label style="margin: 0;">Work Days </label>
                                 
                                </div><div class="acc_add_box" style="width:7%;cursor: pointer">
                                ...
                                <div id="load_check_salary">
                                    
                                    
                                </div>
                                
                                 <div style="width: 5%;margin-top: 20px !important;height: 30px;margin: 0px;float: right " class="search_btn_member_invoice filte_new_box_btn">
                                     <a onclick="submit_salary();"  id="same_page" style="background-color:darkred;margin:0;line-height: 31px;display: none"  href="#">SUBMIT</a>
                                 </div>
...
<script type="text/javascript">
    ...
    function check_data(){
        ...
        if(smonth !='' && syear !=''){
            ...
            var data_v1="set=check_pay_month&smonth="+smonth+"&syear="+syear;
            ...
            $('#same_page').show();
             ...
             var data_v="set=check_adv_paid&smonth="+smonth+"&syear="+syear;
            ...
            $('#error_pop_v').show();
                         ...
                         $('#error_pop_v').text('ALREADY PAID FOR THIS MONTH. PLS GO TO SALARY HISTORY FOR UPDATE');
   ...
   var split_order=new Array();
    $('.details_row_split').each(function(){
            ...
            var sname=$(this).find('.sname').attr('emp_id'); 
             var workday=$(this).find('.workday').val(); 
              ...
              var netsalary=$(this).find('.netsalary').val(); 
               var advance=$(this).find('.advance').val(); 
                var paid=$(this).find('.paid').val(); 
      ...
      if(netsalary==''){
          $('#error_pop_v').show();
                         $('#error_pop_v').css('background-color', 'red');
                         $('#error_pop_v').text('ENTER NETSALARY OF ALL EMPLOYEES');
                         $('#error_pop_v').delay(2000).fadeOut('slow');
                      exit;
      }
        ...
        if(smonth!="" && syear!=''){
        var data_v="set=add_employee_salary&all_staff_data="+split_all_json_detail+"&month="+smonth+"&year="+syear;
			...
			{ 
                         ...
                         $('#error_pop_v').text('SALARY POSTED ');
                         $('#error_pop_v').delay(2000).fadeOut('slow');
                     
                         setTimeout(function(){
                             
                          window.location.href='salary_detail_account.php';
