...
//     }
    ...
    if(cv_amount!='' && cv_date!='' && cv_from!='' && cv_to!='' && cv_remarks!='' && cv_type!='' &&  (cv_type_loan!='' || cv_type_adv!='') ){
      ...
      var ext1=page_check.split('accounts/');   
...
<div class="mian">
   ...
   <div  class="md-modal md-effect-16 printer_add_popup" id="modal-17" style="top:0;width:100%;height:100%">
            ...
            <div onclick="close_pop();" style="background-color:transparent;top: 3px;"  class="md-close close_staff_pop">
            <img src="img/close_ico.png"></div>
        ...
        <div class="col-md-4">
            <div class="group" id="prn_div">   
            <select class="add_printer_drop" id="to_acc1" >
