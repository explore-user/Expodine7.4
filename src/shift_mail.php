...
$a="8.8.8.8";
		...
		while($result_decimal  = mysqli_fetch_array($sql_decimal_va)) 
               ...
               $sql_login_shift="Select *,ts.ser_firstname,tl.ls_username from tbl_shift_details tsd left join tbl_staffmaster ts on ts.ser_staffid=tsd.sd_open_staff left join tbl_logindetails tl on tl.ls_staffid=tsd.sd_open_staff where sd_id='$sl' and sd_day='".$date."'";
...
<body style="margin: 0;padding:0;background-color: #eeeeee;">
    ...
    <div style="width: 100%;height: auto;float:left;padding: 0px;text-align: center;font-family: sans-serif;background-color: #eeeeee">
        ...
        <div class="main_sec" style="width:100%;max-width: 700px;background-color: #fff;height: auto;padding:20px;display: inline-block;margin:auto;margin-top: 20px;">
                ...
                <div style="width: 700px;float: left;height: auto;margin-top: 0px;text-align: center">
                    ...
                    <span style="width: 100%;height: auto;float: left;font-size: 14px;color: #929292;margin-bottom: 10px;">
                    ...
                    <div style="width:700px;height: auto;float:left;padding:0px 0px;margin-top: 10px;">
                        ...
                        <div style="width:189px;height:auto;float:left;background-color:#797575;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 2px #e5e5e5;padding: 20px;">
                        ...
                        <div style="width:189px;height:auto;float:left;background-color:#f5351b;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 2px #e5e5e5;padding: 20px;">
                    ...
                    <div style="width:677px;height: auto;float:left;background-color: #f3f3f3;padding:10px 10px;margin-top: 5px;">
                      

                        <div style="width:677px;height:100px;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;padding-top:25px;margin-bottom:0px">
                            <span style="color:#727272;font-size:18px">TOTAL SALE</span><br>
                            <strong style="color:#f5351b;font-size:48px">'.number_format($totalsales,$decimal).'</strong>
                        </div>
                    ...
                    <div style="width:700px;height: auto;float:left;padding:0px 0px;margin-top:5px;">
                        ...
                        <div style="width:130px;height:auto;float:left;background-color:#e6e6e6;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 2px #e5e5e5;padding: 20px;">
                        ...
                        <div style="width:130px;height:auto;float:left;background-color:#dedede;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 2px #e5e5e5;padding: 20px;">
                        ...
                        <div style="width:130px;height:auto;float:left;background-color:#dadada;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 2px #dcdcdc;padding: 20px;">
                    ...
                    <div style="width:700px;height: auto;float:left;padding:0px 0px;margin-top:10px;">
                        ...
                        <div style="width:172px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 1px #e5e5e5;padding: 0px;">
                    ...
                    <div style="width:674px;height: auto;float:left;padding:0px 0px;margin-top:10px;background-color: darkkhaki;padding: 10px 10px 0px 10px;    line-height: 23px;">
                        ...
                        <span style="width: 33%;height: auto;float: left;font-size: 15px;color: #000;margin-bottom: 10px;text-align: center;">Credit Settle Cash  <strong><br>
                            ...
                            <div style="width:700px;height: auto;float:left;padding:0px 0px;margin-top:12px;">
                                ...
                                <div style="width:189px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 1px #e5e5e5;padding: 20px;">
                                    <span style="color:#666;font-size:14px;line-height:22px">ITEM CANCELLED                                    </span><br>
                                    <strong style="color:#f5351b;font-size:20px">'.$tot_item_cancel_count.'</strong>
                                </div>
                                <div style="width:189px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 1px #dcdcdc;padding: 20px;">
                                    <span style="color:#666;font-size:14px;line-height:22px">BILL CANCELLED/AMOUNT </span><br>
                                    <strong style="color:#f5351b;font-size:20px">'.$tot_count.'/'.number_format($tot_billcancel_all,$_SESSION['be_decimal']).'</strong>
                                </div>
                                <div style="width:189px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin:0px 0 0 0;border:solid 1px #e5e5e5;padding: 20px;">
                                    <span style="color:#666;font-size:14px;line-height:22px">DISCOUNTS
                                    </span><br>
                                    <strong style="color:#f5351b;font-size:20px">'.number_format($totaldiscount,$_SESSION['be_decimal']) .'</strong>
                                </div>
                            ...
                            <div style="width:350px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin-top:20px">
                                ...
                                <table width="350px" border="0" style="line-height:22px;font-size:13px;color:#333;padding:5px;    border: solid 1px #e0e0e0;float:left">
                                  <tbody>
                                   <tr>
                    ...
                    <div style="width:350px;height:auto;float:left;background-color:#fff;text-align:center;font-family:Arial,Helvetica,sans-serif;margin-top:20px">
                        ...
                        <table width="350px" border="0" style="line-height:22px;font-size:13px;color:#333;padding:5px;    border: solid 1px #e0e0e0;float:left">
                          <tbody>
                           <tr>
                          <td style="text-align:left;padding: 5px;border:solid 1px #f3f3f3">Denomination</td>
                          <td style="padding: 5px;border:solid 1px #f3f3f3"  >Count</td>
                          <td  style="text-align:right;padding: 5px;border:solid 1px #f3f3f3">Total</td>
                          </tr>';   
...
$sql_login_shift1="Select distinct(dm.dm_denomination),tc1.dod_count,tc1.dod_value,tsd.sd_changein_close from tbl_shift_details tsd left join tbl_shift_close_denomination tc1 on tc1.dod_shidt_slno=tsd.sd_id  and tsd.sd_day=tc1.dod_day left join tbl_denomination_master dm on dm.dm_id=tc1.dod_deno_id  where  tsd.sd_close = '$shiftclosetime' ";
		...
		while($result_login_shift1  = mysqli_fetch_array($sql_login_shift11)) 
                ...
                <div style="width: 97%;height:auto;float:left;margin-top:12px;background-color: #f9e9d0;padding: 10px 10px;background-image:url(http://explorecommunity.com/ed_report_img_dont_delete/prhp_bg.png);background-size: 100%;">
                ...
                <div style="width:700px;height:auto;float:left;margin-top:0px;background-color:#333;padding:0 0px">
                    <p style="font-family:Arial,Helvetica,sans-serif;color:#a5a5a5;line-height:25px;margin-bottom:2px;text-align:center;margin-top:7px;font-size:13px">
                   
                   E : <a style="color:#a5a5a5;text-decoration:none" href="mailto:info@expodine.com" target="_blank">info@expodine.com </a> |
                    W : <a style="color:#a5a5a5;text-decoration:none" href="http://www.expodine.com/" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.expodine.com/&amp;source=gmail&amp;ust=1582106671508000&amp;usg=AFQjCNFKE-GN1afTSr5DRz3yf0BQbe6E_w"> www.expodine.com</a> |
                    T : +91 9895 366 444
                  <span style="width:700px;height:auto;float:left;padding-bottom:7px"> © Expodine. All right reserved</span>
...
$filename = $folder."Shift_Reports-".$database->convert_date($_SESSION['date']); 


$msg_temp1=strip_tags($msg_temp);


$handle = fopen($filename.'.txt','w+');
fwrite($handle,$msg_temp1);
fclose($handle);           
   ...
   $mailtext   =   preg_replace("|\n|","<br>","$mailtext_o");
        ...
        $mail->Subject =   $branch." - SHIFT REPORT-".$date;
        $mail->Body = $msg_temp;
