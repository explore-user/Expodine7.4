...
.take_botom_button{width: 32%;margin-left: 1%;padding-right: 0;margin-top: 5px;height: 40px;line-height: 40px;border-radius: 5px;}
.take_botom_button a{line-height:39px;font-size:15px;padding-right:0;}
...
<div class="container-fluid no-padding">
    <?php include"includes/topbar_takeaway.php"; ?>
      ...
      <div class="top_site_map_cc take_kot_top_site_map_cc">
      			 <a href="take_away_.php"><div class="bill_his_back_btn"><?=$_SESSION['backta']?></div></a>
            	<ul>
					<!--<li><a href="index.php" title=""><span class="home_icon"></span>\</a></li>-->
					<li><a title=""><?=$_SESSION['kotlistta']?></a></li>
                   
				</ul>
                 <!-- <div class="back_btn"><a href="take_away_.php">Back</a></div>-->
...
//                        echo "Select distinct(tb.tab_billno),tb.tab_time,tb.tab_hdcustomerid ,ts.tac_customername,ts.tac_contactno,tb.tab_status,tb.tab_kotno, tb.tab_mode From tbl_takeaway_billmaster as tb LEFT JOIN tbl_takeaway_customer ts ON ts.tac_customerid=tb.tab_hdcustomerid Where (tb.tab_status = 'TA' OR tb.tab_status = 'HD') AND tb.tab_dayclosedate ='".$_SESSION['date']."' And tb.tab_kotno != '' And (tb.tab_status='KOT_Generated' OR tb.tab_status='Processing' OR tb.tab_status='Ready') order by tb.tab_status ASC";
			 ...
			 echo "<span style='color: #F00E0E;'> Nothing to display </span>";
               ...
               <div class="take_away_bottom_inform_cc take_away_kot_bottom_inform_cc">
               		<div class="take_away_bottom_inform">
                        ...
                        <div class="tka_inform_text"><?=$_SESSION['homedel_ta']?></div>
                    </div>
                    <div class="take_away_bottom_inform">
                    	<div style="background-color:#fff" class="tka_inform_color"></div>
                        <div class="tka_inform_text"><?=$_SESSION['takeway_ta']?></div>
                    </div>
        	...
        	<div style="min-height: 595px;" class="right_main_cc">
                ...
                <div class="take_oder_right_detail">
                	<div style="border-bottom: 1px solid rgba(255,255,255,0.1);min-height:240px;" class="take_right_inform_cc">
                            <div class="take_oder_odred_name"><span><?=$_SESSION['ordernota']?> : </span>  <span id="ta_loadtakbill"></span> <span style="text-align:right">KOT : </span> <span id="ta_loadtakkotl"></span></div>
...
<script src="js/takeaway_list.js"></script>
