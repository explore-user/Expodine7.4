  ...
  $("#datepickerfrom").datepicker({
	...
	$('#datepickerfrom').change(function () {
		...
		{ //alert(fromval)
			tot_to="";
                ...
                $.post("load_shiftdetails.php", {fromdt:fromval,todt:tot_to,ft:"set"},
		function(data)
		{
                    data=$.trim(data);
                    if(data!="sorry")
	...
	$('#bydate').change(function () {
		...
		$("#rptstatus").delay(1000).fadeOut('slow');
						...
						$.post("load_shiftdetails.php", { bydate:'',fromdt:'',todt:'',},
						function(data)
						{
							  data=$.trim(data);
                                                          if(data!="sorry")
...
function shiftdetails(sl,date,dateclose)
{
  ...
  if(dateclose=="")
  {
      ...
      $('.alert_error_popup_all_in_one').show();
                        ...
                        $('.alert_error_popup_all_in_one').text('Please Close The Shift To Print');
  ...
  else
  {
    $.ajax({
                ...
                data: "set=shift_detail&slno="+sl+"&date="+date,
                ...
                success: function(data)
                {
                   ...
                   $('.alert_error_popup_all_in_one').show();
                        ...
                        $('.alert_error_popup_all_in_one').text(' PRINTED');
                        $('.alert_error_popup_all_in_one').delay(1000).fadeOut('slow');
        }
        });
}
...
<body>
 ...
 <?php include "includes/left_menu.php"; ?>
    ...
    <input type="hidden" value="<?=$_SESSION['ser_force_close']?>"  id="forceclose_on" >
    
    
 <div  class="sitemap_cc">SHIFT DETAILS</div>
  <div id="container">  
               ...
               <option value="null" default>--Select--</option>
                <option value="Today" >Today</option>
                 <option value="Yesterday" >Yesterday</option>
                    ...
                    <?php   if( $_SESSION['ser_force_close']=='Y'){ ?>
                                <div class="search_name_box_main" style="float:right;color:red ">
                                    <div class="text-selection_name"></div>
                                     <div class="input-group">
                                         <input type="text" readonly autocomplete="off" class="form-control" id="" on style="color:darkred;cursor: pointer " onclick="shift_close_all()" value="Force Close All" >            
                                    </div>
                                 </div>
...
function shift_mail_send(slno_print,dayclose_shift,dateclose){
    ...
    var datarp2="set=shift_email&slnoshift="+slno_print+"&day_shift="+dayclose_shift;
        ...
        success: function(data)
        {
          ...
          $('.alert_error_popup_all_in_one').show();
                        ...
                        $('.alert_error_popup_all_in_one').text(' Mail Send');
                        $('.alert_error_popup_all_in_one').delay(1000).fadeOut('slow');
...
function confirm_yes_new(){
    ...
    var datarp2="set=shift_close_all";
        ...
        success: function(data)
        {
           ...
           $('.alert_error_popup_all_in_one').show();
                        ...
                        $('.alert_error_popup_all_in_one').text('CLOSED ALL SHIFTS');
                        $('.alert_error_popup_all_in_one').delay(1000).fadeOut('slow');
...
function shift_close_all(){
    
    
    $('#confirm_pop_all').show();
                
    $('#pop_head_com').text('WARNING : FORCE CLOSE ALL SHIFTS IN OUTLET ?');
