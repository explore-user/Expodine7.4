...
//    }
		...
		$insertion['cor_reason'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($_REQUEST['comp1']));
              //  $insertion['cor_active'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($act));
	
         
$sql=$database->check_duplicate_entry('tbl_complementory_reasons',$insertion);
 if($sql!=1)
	{
	$insertid              			=  $database->insert('tbl_complementory_reasons',$insertion);
	}
}	
...
$result=$database->mysqlQuery("UPDATE  tbl_complementory_reasons SET  cor_reason='" .$_REQUEST['compedit']."', cor_active='$chck'  where id='".$_REQUEST['hideditcomp']."'");
...
<div class="mian">
	<div class="view-container">
		<div style=" top: 58px;"  id="container">
			<div class="breadcrumbs">
				<ul>
					...
					<li><a style="cursor:pointer">Complimentary</a></li>
                ...
                <?php } ?>
                            ...
                            <h3 style="background: #fff;margin-bottom: 0;padding: 13px;">COMPLIMENTARY BILL SETTLE REASONS<a style="float:right;border: solid 1px;font-size: 15px;padding: 3px;font-weight: bold " href="complimentary_reason.php">RESET</a></h3>
                       <div class="cc_new_main">

                                           <div class="col-md-12 add_btn_cc_2">
                      <div class="btn_cc_2">
                   		<a tittle="Add" href="#" id="add_comp_reason" class="md-trigger add_btn_2" data-modal="modal-17" ></a>
                      </div>  
                   </div>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th  height="30">Reason</th>
                                 ...
                                 <?php
                                 $sl=1;
	 $sql_login  =  $database->mysqlQuery("select * from tbl_complementory_reasons"); 
	 ...
	 ?>
    						<tr >
                                                    <td          width="10%"><?=$sl++?></td>
                                <td  width="70%"><?=$result_login['cor_reason']?></td>
                                <?php if($result_login['cor_active']=="Y"){
                                    $sts12="Active";
                                }  else {
                                        $sts12="Inactive";
                                }
                                ?>
                                  ...
                                  <td     width="10%">
<!--                                      editclick-->
<a  href="#" class="md-trigger editclick"    rsnid="<?=$result_login['id']?>"><img src="images/edit_page.PNG"></a>
			...
			<div class="md-content"  >
				...
				<div>
                    <div class="col-lg-12 col-md-12 no-padding">
                        <form role="form" action="complimentary_reason.php"  method="post"  name="compform"  >
                        	 ...
                        	 <div class="first_form_contain">
                             	<div class="form_name_cc">Reason<span style="color:#F00">*</span></div>
                               	 <div class="form_textbox_cc" id="feedback_div">
                                     <input tabindex="1" type="text" class="form-control cancellation" id="comp1" name="comp1"  placeholder="Reason"></div>
...
$(document).ready(function() {
    ...
    $("#add_comp_reason").click(function()
    {
        $("#comp1").focus();
    });
