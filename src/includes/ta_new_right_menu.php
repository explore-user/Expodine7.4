  ...
  <div class="backto_table_select back_bill_his new_right_drop" >
                  <ul>
					...
					<div class="right_quick_mn_head">Menus</div>
               ...
               <?php if(in_array("take_away", $_SESSION['menuarray'])) { ?>
                    ...
                    <li>
                        <a href="take_away_list_bill.php" <?php if($linkname=='take_away_list_bill.php'){ ?>class="top_menu_active" <?php } ?> title="">TA - Bill1</a>
                    </li>
                    <?php } ?>
