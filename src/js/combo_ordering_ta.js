  ...
  localStorage.adding_click_count=0;
    ...
    //                                alert($(this).find('.menu_qty_display').val());
                         ...
                         var food= $('.online_order_box_act').attr('food_val');
                            ...
                            var dataString = "value=combo_adding&combo_menu_details="+combo_menu_jsonstring+"&cod_count_combo_ordering="+localStorage.cod_count_combo_ordering+"&combo_stock_check="+combo_stock_check+"&stock_left="+stock_left+"&food="+food;
                            $.ajax({
                                type: "POST",
