...
$(document).ready(function(){
	...
	setInterval(function() {
		...
		if(serchval=="")
		{
		 $('#ta_listallorders').load('load_takeaway.php?value=listalltakeaways&selectval='+selected);
		}else
		{
			if(selected=="")
			{
			...
			{
				$('#ta_listallorders').load('load_takeaway.php?value=ta_searcheachitem&serchval='+serchval+'&selectval='+selected);
			}
		}
		}, 3000);
	/*************************************** auto refresh  ends *************************************************  */
