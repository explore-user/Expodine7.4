$(function(){
                    ...
                    'layout': [
                        ...
                        [
                            [
                                ...
                                ['Bksp', '8', 8, 3, true], ['Space', '32', 32, 12, false], ['Clear', '46', 46, 3, false], ['CLOSE', '27', 27, 3, false]
                            ]
                        ]
                    ]
                }
                $('input.search_code_keypad').initKeypad({'keyboardLayout': keyboard});
    ...
    $(document.body).on("mousedown", ".jQKeyboardContainer", function (e) {
        $dragging = $(e.target);
    });
