$(document).ready(function(){ 
  ...
  localStorage.adding_click_count=0;
    ...
    //                                alert($(this).find('.menu_qty_display').val());
                            ...
                            var dataString = "set=combo_adding&combo_menu_details="+combo_menu_jsonstring+"&cod_count_combo_ordering="+localStorage.cod_count_combo_ordering+"&combo_stock_check="+combo_stock_check+"&stock_left="+stock_left;
                            $.ajax({
                                type: "POST",
                                url: "load_div.php",
                                data: dataString,
                                success: function(data) {
                                    ...
                                    if(localStorage.cod_count_combo_ordering==''){
                                        $(".loaderror").text("Item Added Sucessfully");
                                    }else{
