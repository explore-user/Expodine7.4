...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_REQUEST['reg1'])   )
{
...
//    }
		...
		$insertion['rr_reason'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($_REQUEST['reg1']));
             //   $insertion['rr_active'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($act));
	
         
$sql=$database->check_duplicate_entry('tbl_regenerate_reasons',$insertion);
 if($sql!=1)
	{
	$insertid              			=  $database->insert('tbl_regenerate_reasons',$insertion);
	}
}	

if($_SERVER['REQUEST_METHOD']=='POST' && isset($_REQUEST['regedit'])   )
{
if(isset($_REQUEST['regactive'])){
    $chck="Y";
}  else {
    $chck="N";
}

$result=$database->mysqlQuery("UPDATE  tbl_regenerate_reasons SET  rr_reason='" .$_REQUEST['regedit']."', rr_active='$chck'  where rr_id='".$_REQUEST['hideditreg']."'");
...
<div class="mian">
	<div class="view-container">
		<div style=" top: 58px;"  id="container">
			<div class="breadcrumbs">
				<ul>
					...
					<li><a style="cursor:pointer">Regenerate</a></li>
				...
				<div class="als-viewport" style="width:100% !important;">
                    ...
                    <?php if( in_array("cancellation", $_SESSION['menusubarray'])  ) { ?>                     
                ...
                <li class="als-item"><a href="regeneration.php" class="new_tab_btn <?php if($linkname=="regeneration.php"){ ?> active_btn_1 <?php } ?>">REGENERATION BILL REASON</a></li>
                            ...
                            <h3 style="background: #fff;margin-bottom: 0;padding: 13px;">REGENERATION REASONS <a style="float:right;border: solid 1px;font-size: 15px;padding: 3px;font-weight: bold " href="regeneration.php">RESET</a></h3>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th  height="30">Reason</th>
                                 ...
                                 <?php
                                 $sl=1;
	 $sql_login  =  $database->mysqlQuery("select * from tbl_regenerate_reasons"); 
	 ...
	 ?>
    						<tr >
                                                    <td          width="10%"><?=$sl++?></td>
                                <td  width="70%"><?=$result_login['rr_reason']?></td>
                                <?php if($result_login['rr_active']=="Y"){
                                    $sts12="Active";
                                }  else {
                                        $sts12="Inactive";
                                }
                                ?>
                                  ...
                                  <td   width="10%"><?=$sts12?></td>
                                  <td     width="10%">
<!--                                      editclick-->
<a  href="#" class="md-trigger editclick"    rsnid="<?=$result_login['rr_id']?>"><img src="images/edit_page.PNG"></a>
			...
			<div class="md-content"  >
				...
				<div>
                    <div class="col-lg-12 col-md-12 no-padding">
                        <form role="form" action="regeneration.php"  method="post"  name="regform"  >
                        	 ...
                        	 <div class="first_form_contain">
                             	<div class="form_name_cc">Reason<span style="color:#F00">*</span></div>
                               	 <div class="form_textbox_cc" id="feedback_div">
                                     <input type="text" tabindex="1" class="form-control cancellation" id="reg1" name="reg1"  placeholder=" Reason"></div>
...
<!--                                                <div class="first_form_contain">
                             	<div class="form_name_cc">Active</div>
                               	 <div class="form_textbox_cc" id="active_div">
                                 	<div class="checkbox">
                    <label>
                        <input type="checkbox"   value="Y" tabindex="2" name="activereg"  id="activereg" data-toggle="tooltip" title="Active">
...
function     validate_editcancel (){
        if($("#regedit").val()=="")
        {
                 ...
                 document.regformedit.regedit.focus();
        }else
        {
        document.regformedit.submit();
    }
    }
