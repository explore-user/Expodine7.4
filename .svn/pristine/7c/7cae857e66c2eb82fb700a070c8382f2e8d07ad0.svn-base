...
function print_page()
{
 ...
 $("#datepickerfromsales").datepicker({
	 ...
	 $("#datepickertodtsales").datepicker({
	  ...
	  maxDate: "+0D "
       ...
       $("#dayselector").slideToggle();
         ...
         $('#online_partner_type').change(function () 
            {
          var type=$(this).val();
         
        if(type=='Local'){
            $('#online_partner').css("display", "block");
             $('#online_partner2').css("display", "none");
            $('#online_partner1').css("display", "none");
        }else if(type=='Online'){
           $('#online_partner1').css("display", "block"); 
            $('#online_partner2').css("display", "none");
           ...
           $('#online_partner2').css("display", "block");
        }
		...
		var type_online=$('#online_partner_type').val();
      
        if(type_online=='Local'){        
	   var partner=$('#online_partner_id').val();
        } else if(type_online=='Online'){
            partner=$('#online_partner_id1').val(); 
       }else if(type_online=='Qr_code'){
            partner=$('#online_partner_id2').val(); 
       }
       
        var partner_mode=$('#online_partner_mode').val();          
		$.post("load_tareportcheck.php", {fromdt:'',todt:'',bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},                                                        
			  function(data)
			  {
					data=$.trim(data);         
					if(data!="sorry")
					{
						$.post("load_tareport.php", {fromdt:'',todt:'',bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},
						function(data)
						{
							  data=$.trim(data);
	...
	/*******************************************type  of sales change starts**********************************************/
		...
		$.post("load_hdreportcheck.php", {fromdt:fromval,todt:tot_to,type:typeval,typesale:typesale,staffsel:staffsel,bydate:bydate,sale:"sl"},
		...
		$.post("load_tareportcheck.php", {fromdt:fromval,todt:tot_to,type:typeval,typesale:typesale,loginstaffsel:staffsel,bydate:bydate},
       ...
       var cus_add=$('#cus_add').val();
                 var partner_mode=$('#online_partner_mode').val();
		$.post("load_tareportcheck.php", {fromdt:fromval,todt:tot_to,type:typeval,bydate:bydate,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},
			  function(data)
			  {
					data=$.trim(data);
					if(data!="sorry")
					{
						$.post("load_tareport.php", {fromdt:fromval,todt:tot_to,bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day,name:name,cus_add:cus_add},
						function(data)
						{
							  data=$.trim(data);
							  $('#reportload').html(data);
	   ...
	   var partner=$('#online_partner_id').val();
		...
		if(tot_from=="")
		{
			tot_from="";
                 ...
                 var name=$('#cus_name').val();
                var sortby=$('#bill_sort').val();
			$.post("load_tareportcheck.php", {fromdt:tot_from,todt:tot_to,bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},
			  function(data)
			  {
					data=$.trim(data);
					if(data!="sorry")
					{
						$.post("load_tareport.php", {fromdt:tot_from,todt:tot_to,bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day,name:name,cus_add:cus_add},
						function(data)
						{
							  data=$.trim(data);
	...
	/*	$.post("load_report.php", {fromdt:tot_from,todt:tot_to,type:typeval,set:"ft"},
     ...
     $('#online_partner_id1').change(function () 
            {
	 ...
	 $('#datepickertodtsales').val("");
		var type_online=$('#online_partner_type').val();
		var partner=$('#online_partner_id1').val();
                var partner_mode=$('#online_partner_mode').val();
	 ...
	 $('#datepickertodtsales').val("");
		...
		$.post("load_tareportcheck.php", {fromdt:'',todt:'',bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},                                                        
			  function(data)
			  {
					...
					if(data!="sorry")
					{
						$.post("load_tareport.php", {fromdt:'',todt:'',bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online,name:name,cus_add:cus_add},
						function(data)
						{
							  data=$.trim(data);
							  $('#reportload').html(data);
	...
	$('#menu_type').change(function () {
		...
		$.post("load_tareportcheck.php", {type:typeval,fromdt:fromval,todt:tot_to,bydate:bydate,addon:addon},
			  function(data)
			  { 
					data=$.trim(data);
...
$('#bydate').val("null");
	...
	$('#bydate').change(function () {
	 ...
	 $('#datepickerfrom').val("");
		...
		var bydate=$('#bydatesales').val();
		$.post("load_tareportcheck.php", {fromdt:fromval,todt:tot_to,sortby:sortby,type:typeval,bydate:bydate,sortby:sortby,set:"ft"},
			  function(data)
			  {
					data=$.trim(data);
                                ...
                                <div class="text-selection_name">Type</div>
                                   <div class="input-group" style="width: 84%;">
                                         <select  class="form-control add_new_dropdown_report" onChange="reportcreate(this.value)" name="typeval" id="typeval">
                                           ...
                                           <?php  
                                         $sql_login  =  $database->mysqlQuery("select rm_reportid,rm_printa4,rm_posprintofanother,rm_reportname from tbl_reportmaster where rm_reportview='Y' and rm_reporttype='OL'"); 
                                  ...
                                  <div id="online_partner_mode_div" style="display:none">
                                    ...
                                    <div class="text-selection_name">Mode</div>
                                     <div class="input-group">
                                      ...
                                      <div id="online_partner_mode_div" class="ol_type" style="display:block">
                                      <div class="search_name_box_main">
                                    <div class="text-selection_name">Type</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" id="online_partner_type" >
                                      ...
                                      <div class="search_name_box_main cus_div" style="display:none">
                                    <div class="text-selection_name">Name</div> 
                                     <div class="input-group">
                                         <input type="text" class="form-control" id="cus_name" onkeyup="search_cus();" >            
                                    </div>
                                 </div>
                                      
                                      
                                       <div class="search_name_box_main cus_add_div" style="display:none">
                                    <div class="text-selection_name">Number</div> 
                                     <div class="input-group">
                                         <input type="text" class="form-control" id="cus_add" onkeyup="search_cus_add();" >            
                                    </div>
                                 </div>
                                  
                                  <div id="online_partner" >
                                      <div class="search_name_box_main">
                                    <div class="text-selection_name">Local Partners</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" name="loginstaffsel" id="online_partner_id">
                                              <option value="" >All</option>
                                             
                                            <?php
                                            $sql_logstaff2  =  $database->mysqlQuery("SELECT * from tbl_online_order WHERE tol_local_order='Y' and tol_status='Y'"); 
                                      ...
                                      <div id="online_partner1" style="display:none">
                                      <div class="search_name_box_main">
                                    <div class="text-selection_name">Online Partners</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" name="loginstaffsel" id="online_partner_id1">
                                              <option value="" default>All</option>
                                             
                                            <?php
                                            $sql_logstaff2  =  $database->mysqlQuery("SELECT * from tbl_online_order WHERE   tol_status='Y'"); 
                                            $num_logstaff2   = $database->mysqlNumRows($sql_logstaff2);
                                            if($num_logstaff2){
                                                while($result_logstaff2  = $database->mysqlFetchArray($sql_logstaff2)) {
                                                    ?>
                                       ...
                                       <div id="online_partner2" style="display:none">
                                      <div class="search_name_box_main">
                                    <div class="text-selection_name">Qr Partners</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" name="loginstaffsel" id="online_partner_id2">
                                              <option value="" default>All</option>
                                             
                                            <?php
                                            $sql_logstaff2  =  $database->mysqlQuery("SELECT * from tbl_online_order WHERE  tol_qr_order='Y' and tol_status='Y'"); 
                                            $num_logstaff2   = $database->mysqlNumRows($sql_logstaff2);
                                            if($num_logstaff2){
                                                while($result_logstaff2  = $database->mysqlFetchArray($sql_logstaff2)) {
                                                    ?>
                                 ...
                                 <div class="search_name_box_main">
                                    <div class="text-selection_name">To  :</div>
                                     <div class="input-group">
                                         ...
                                         <div class="search_name_box_main" id="bydat_div">
            	<div class="text-selection_name">By Date</div>
                  <div class="input-group">
    ...
    document.getElementById("display_timefrom").innerHTML = displayTime;
		...
		$.post("load_consolidatedreportcheck.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate:bydate,department:mode,fromtime:fromtime,totime:totime,day:day},
		  function(data)
			...
			if(data!="sorry")
                            {
				$.post("load_tareport.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate:bydate,department:mode,fromtime:fromtime,totime:totime,day:day},
				function(data)
				   {
					data=$.trim(data);
					$('#reportload').html(data);
...
function search_cus_add(){
		...
		$.post("load_consolidatedreportcheck.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate:bydate,department:mode,fromtime:fromtime,totime:totime,day:day},
		  function(data)
			...
			if(data!="sorry")
                            {
				$.post("load_tareport.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate:bydate,department:mode,fromtime:fromtime,totime:totime,day:day,name:name,cus_add:cus_add},
				function(data)
				   {
					data=$.trim(data);
					$('#reportload').html(data);
...
function reportcreate(rpt)
{
	...
	{     $('#online_partner_mode_div').css("display", "block");
	   ...
	   var partner=$('#online_partner_id').val();
        ...
        var partner_mode=$('#online_partner_mode').val();
					$.post("load_tareport.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
         ...
         else if(repttype=="qr_sale_timely")
	{   $('.cus_add_div').css("display", "none");
            $('.cus_div').css("display", "none");
             $('.cus_add_div').css("display", "none");
             $('#fromtimediv').css("display","block");
              $('#totimediv').css("display","block");
              $('#bydat_div').css("display", "none");
             $('.ol_type').css("display", "none");
	   ...
	   var partner=$('#online_partner_id').val();
        ...
        var partner_mode=$('#online_partner_mode').val();
				$.post("load_tareport.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
	 ...
	 else if(repttype=="qr_customer_report")
	 {    
             $('.cus_add_div').css("display", "block");
             $('.cus_div').css("display", "block");
             $('#fromtimediv').css("display","none");
             $('#totimediv').css("display","none");
             $('#bydat_div').css("display", "block");
             $('.ol_type').css("display", "none");
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var name=$('#cus_name').val();
                 ...
                 var partner_mode=$('#online_partner_mode').val();
					...
					$.post("load_tareport.php", {type:repttype,fromdt:fromval,todt:tot_to,bydate,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,sortby:sortby,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day,name:name,cus_add:cus_add},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
	 ...
	 else if(repttype=="qr_item_report")
	{    
             $('.cus_add_div').css("display", "none");
              $('.cus_div').css("display", "block");
             $('#fromtimediv').css("display","none");
	   ...
	   var partner=$('#online_partner_id').val();
         ...
         else if(repttype=="online_item_report")
	{    
             $('.cus_add_div').css("display", "none");
              $('.cus_div').css("display", "none");
             $('#fromtimediv').css("display","none");
	...
	if(check==true)
	{
	   ...
	   var partner=$('#online_partner_id').val();
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var totime=$('#display_timeto').html();
					...
					window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&partner="+partner+"&partner_mode="+partner_mode+"&type_online="+type_online+"&fromtime="+fromtime+"&totime="+totime+"&day="+day;
				
				
		  
		}
                 else if(vv=="qr_item_report")
		{
	   ...
	   var partner=$('#online_partner_id').val();
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var partner_mode=$('#online_partner_mode').val();
                 ...
                 var name=$('#cus_name').val();
                 var cus_add=$('#cus_add').val();
					window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&partner="+partner+"&partner_mode="+partner_mode+"&type_online="+type_online+"&fromtime="+fromtime+"&totime="+totime+"&day="+day+"&name="+name+"&cus_add="+cus_add;
				
		}
                 else if(vv=="qr_sale_timely")
		{
	   ...
	   var partner=$('#online_partner_id').val();
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var totime=$('#display_timeto').html();
					...
					window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&partner="+partner+"&partner_mode="+partner_mode+"&type_online="+type_online+"&fromtime="+fromtime+"&totime="+totime+"&day="+day+"&cus_add="+cus_add+"&name="+name;
	   ...
	   var partner=$('#online_partner_id').val();
        ...
        var partner_mode=$('#online_partner_mode').val();
					...
					window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&partner="+partner+"&partner_mode="+partner_mode+"&type_online="+type_online;
		}
                ...
                else if(vv=="order_ta")
		{
			...
			var hidbydate=$('#bydatesales').val();
			var addon=$('#menu_type').val();
			$.post("load_tarptcheck.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,addon:addon},
		  function(data)
		  {
			  	data=$.trim(data);
                ...
                else if(vv=="total_summary_details_ta")
		{
			...
			$.post("load_tarptcheck.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate},
		  function(data)
		  {
			  	data=$.trim(data);
                 ...
                 else if(vv=="cancel_history_ta")
		{
			...
			$.post("load_tarptcheck.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,loginstf:staffsel},
		  function(data)
		  {
			  	data=$.trim(data);
        ...
        if(vv=="tot_sales_ta")
            {
      		...
      		$.post("load_tareportcheck.php", {type:vv,fromdt:tot_from,todt:tot_to,bydate:hidbydate,staffsel:staffsel},
		function(data)
                    {
			data=$.trim(data);
if(data !="sorry")
	   ...
	   var partner=$('#online_partner_id').val();
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var a4paper=$('#hida4settings').val();
                                ...
                                if(printera4=="N")
                                    {
                    window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&partner="+partner+"&partner_mode="+partner_mode+"&staffsel="+staffsel+"&type_online="+type_online+"#print",'_blank');
                                    }
                                else
                                    {
                                        $.post("ta_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,staffsel:staffsel,partner:partner,partner_mode:partner_mode,type_online:type_online},
                                        function(data)
                                            {
                                                data=$.trim(data);
	   ...
	   var partner=$('#online_partner_id').val();
        ...
        var cus_add=$('#cus_add').val();
                ...
                var a4paper=$('#hida4settings').val();
                                ...
                                if(printera4=="N")
                                    {
                    window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&partner="+partner+"&partner_mode="+partner_mode+"&staffsel="+staffsel+"&fromtime="+fromtime+"&totime="+totime+"&day="+day+"&name="+name+"&type_online="+type_online+"&cus_add="+cus_add+"#print",'_blank');
                                    }
                                else
                                    {
                                        $.post("ta_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,staffsel:staffsel,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day},
                                        function(data)
                                            {
                                                data=$.trim(data);
	   ...
	   var partner=$('#online_partner_id').val();
            ...
            partner=$('#online_partner_id1').val(); 
                ...
                var a4paper=$('#hida4settings').val();
                                ...
                                if(printera4=="N")
                                    {
                    window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&partner="+partner+"&partner_mode="+partner_mode+"&staffsel="+staffsel+"&fromtime="+fromtime+"&totime="+totime+"&day="+day+"&type_online="+type_online+"#print",'_blank');
                                    }
                                else
                                    {
                                        $.post("ta_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,staffsel:staffsel,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day},
            ...
            partner=$('#online_partner_id1').val(); 
               ...
               var a4paper=$('#hida4settings').val();
                 ...
                 var cus_add=$('#cus_add').val();
                   ...
                   if(printera4=="N")
                    {
                    window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&partner="+partner+"&partner_mode="+partner_mode+"&staffsel="+staffsel+"&fromtime="+fromtime+"&totime="+totime+"&day="+day+"&type_online="+type_online+"&name="+name+"&cus_add="+cus_add+"&#print",'_blank');
                     }
                      else
                      {
                                        $.post("ta_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,staffsel:staffsel,partner:partner,partner_mode:partner_mode,type_online:type_online,fromtime:fromtime,totime:totime,day:day},
	   ...
	   var partner=$('#online_partner_id').val();
        ...
        else if(vv=="billreport_ta")
            {
                ...
                var sortby=$('#bill_sort').val();
                var a4paper=$('#hida4settings').val();
      		$.post("load_tareportcheck.php", {type:vv,fromdt:tot_from,todt:tot_to,bydate:hidbydate,staffsel:staffsel,sortby:sortby},
		function(data)
                    {
			data=$.trim(data);
        ...
        else if(vv=="total_summary_details_ta")
		{
			...
			var hidbydate=$('#bydatesales').val();
                       ...
                       var a4paper=$('#hida4settings').val();
      			$.post("load_tareportcheck.php", {type:vv,fromdt:tot_from,todt:tot_to,bydate:hidbydate},
		  function(data)
		  {   
			  	data=$.trim(data);
			if(data !="sorry")
...
if(data !="sorry")
        ...
        else if(vv=="cancel_history_ta")
		{
			...
			var hidbydate=$('#bydatesales').val();
                       ...
                       var a4paper=$('#hida4settings').val();
      			$.post("load_tareportcheck.php", {type:vv,fromdt:tot_from,todt:tot_to,bydate:hidbydate,loginstf:staffsel},
          function(data)
		  { 
			  	data=$.trim(data);
				if(data !="sorry")
		...
		$("#rptstatus").delay(1000).fadeOut('slow');
			...
			var hidbydate=$('#bydatesales').val();
                        var addon=$('#menu_type').val();                  		
				$.post("load_tareportcheck.php", {type:vv,fromdt:tot_from,todt:tot_to,bydate:hidbydate,addon:addon},
		  function(data)
		  {
			  	data=$.trim(data);
	...
	if(vv=="tot_sales_ta")
		...
		var hidbydate=$('#bydate').val();
                var loginstaff=$('#userloginsel').val();
                  ...
                  $.post("load_takeawayrptcheck.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,loginstaff:loginstaff},
		  function(data)
		  {
			  	data=$.trim(data);
