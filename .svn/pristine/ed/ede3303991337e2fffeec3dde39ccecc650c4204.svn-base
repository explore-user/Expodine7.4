...
<div  class="dfineheading"> <strong>Edit</strong>    <span style="font-size: 14px;padding-left:1%;">  ID -<?=$src ?></span></div> 
                        	...
                        	<input type="hidden" class="form-control vouchernames" id="date1"  placeholder="Date" tabindex="0"  data-toggle="tooltip" title="Date" value="<?=$result_login['vp_date']?>">
                                   ...
                                   <div class="form_textbox_cc" id="menumaincategory_divs" > <div class="form-group" id="voucher_divs">
										 ...
										 $sql_kot  =  $database->mysqlQuery("select * from tbl_voucherhead where vh_active='Y'"); 
										  ...
										  if($num_kot){
                                                                                             ?>
                                           <select data-placeholder="Enter Voucher Name" id="vhid1" name="vhid1" data-rel="chosen" tabindex="1" autofocus="autofocus" title="Voucher Name" left"." data-toggle="tooltip" class="form-control vhid1 add_new_dropdown">
<!--                                <option value=""></option>-->
...
<!--                                            <option value=""></option>-->
                                ...
                                <!--cheque-->
                                <div class="cheque_ccedit" style="display:none">
                            <div class="first_form_contain" style="width:49%">
                                <span id="vouchereditchk" class="load_error alertsmaster" style="color:#F00" ></span>
                           ...
                           <div class="first_form_contain" style="width:49%">
                            ...
                            <input type="text" class="form-control" id="amount1" onkeypress='return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)' name="amount1"  placeholder="Amount" tabindex="9"  data-toggle="tooltip" title="Amount" value="<?=$result_login['vp_amount']?>">
                                </div>
                               </div>
                            ...
                            <div class="first_form_contain" style="width:49%">
                                <span id="vouchereditchk" class="load_error alertsmaster" style="color:#F00" ></span>
                             	<div class="form_name_cc">Journal No</div>
                               	<div class="form_textbox_cc" id="receivedby_divs">
                            <input type="text" class="form-control" id="voucherbillno1" name="voucherbillno1"  placeholder="No" tabindex="11"  data-toggle="tooltip" title="Received by" value="<?=$result_login['vp_voucherno']?>">
                                </div>
                               </div>
                    ...
                    <div style="width:100%"  class="first_form_contain">	
                        <div style="width:19%;" class="form_name_cc">Remark </div>
                                <div style="height: auto;width: 78%;" class="form_textbox_cc" id="receivedby_div">
                                             <textarea id="remark1" name="remark1" class="form-control receivedby" placeholder="remark" tabindex="11"  data-toggle="tooltip"><?=$result_login['vp_add_remark']?></textarea></div>
                                </div>
                                
                                
                                <div class="first_form_contain" style="width:100%">
                               	<a  href="#" class="entersubmit"  onClick="update_voceval()" tabindex="12"><span class="md-save newbut">Update</span></a>
                              </div>
                   </form>  
                                <?php }} ?>
</div>
