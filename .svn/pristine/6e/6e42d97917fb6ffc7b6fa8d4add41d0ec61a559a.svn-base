...
<head>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div <?php  if( $_SESSION['ser_central_kitchen']!='Y' ||  $_SESSION['be_central_kitchen']!='Y' ){ ?> class="disablegenerate"  <?php } ?> >
            ...
            <div class="loyalty_mgmt_head"><div class="">
                    ...
                    <?php  if( $_SESSION['ser_central_kitchen']=='Y' && $_SESSION['be_central_kitchen']=='Y' ){ ?>
                    <a   class="inv-req-btn1"  href="central_kitchen.php">BACK</a>
                    <?php  }else{ ?>
                    <a   class="inv-req-btn1"  href="index.php">HOME</a>
                     <?php  } ?>
                    
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">CENTRAL KITCHEN HISTORY</a>
...
<div class="inv-req-history" >
 ...
 <input autocomplete="off" onkeyup="search_history();" placeholder="Id" id="search_id" type="text" style=""> 
      ...
      <select onchange="search_history();"  id="staff" style="display:none">
    ...
    <?php } } ?>
        ...
        <select onchange="search_history();"  id="central_type">
            
          <option <?php if($_SESSION['be_central_kitchen']=='Y'){ ?> selected <?php } ?> value="Transfer">Transfer</option>  
          <option <?php if($_SESSION['be_central_kitchen'] !='Y'){ ?> selected <?php } ?> value="Accept">Accept</option>  
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
      ...
      $('#load_history').html(' << LOADING DATA >> ');
     
        var data="set=load_transfer_central_history&id=&fromdt=&todt=&staff=&search_id=&central_type="
             $.ajax({
        type: "POST",
    ...
    function pagination(p,q)
 {
   ...
   var central_type=$('#central_type').val();
              var data="set=load_transfer_central_history&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&search_id="+search_id+"&central_type="+central_type
    ...
    function phy_items(id){
        ...
        $('.item_pop').show();
         ...
         var data="set=load_transfer_central_items&id="+id
 ...
 function search_history(){
   ...
   var staff=$('#staff').val();
    ...
    var search_id=$('#search_id').val();
              ...
              var data="set=load_transfer_central_history&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&search_id="+search_id+"&central_type="+central_type
