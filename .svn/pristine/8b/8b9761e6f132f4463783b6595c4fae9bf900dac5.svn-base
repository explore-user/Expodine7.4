...
#flot-1ine .tickLabel {color:#9E9E9E;}
.sm_graph_detail{height:24vh;min-height:130px}
.balance-widget{min-height:128px;height:20vh;}
</style>
                        ...
                        <div class="anylst_report_container">
                            	...
                            	<div class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
										...
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $tot_sale = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' AND tab_dayclosedate  ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										...
										if($num_menuss){	
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($tot_sale,$_SESSION['be_decimal'])?></div>
                                ...
                                <div class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                        ...
                                        <?php
										$cash=0;
										$sql_menulists="select  (sum(bm_amountpaid) - sum(bm_amountbalace))  as tot 
                                                                                from tbl_tablebillmaster 
                                                                                left join tbl_paymentmode on tbl_tablebillmaster.bm_paymode=tbl_paymentmode.pym_id 
                                                                                where  bm_status='Closed'  and bm_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $cash = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  (sum(tab_amountpaid) - sum(tab_amountbalace))  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where  tab_status='closed' AND tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($cash,$_SESSION['be_decimal'])?></div>
                                ...
                                <div class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                        ...
                                        <?php                                   $card = 0;
										$sql_menulists="select sum(bm_transactionamount) as tot from tbl_tablebillmaster  
                                                                                where bm_status <> 'Cancelled' and bm_credit <> 'Y' and bm_dayclosedate ='".$_SESSION['date']."'"; 
//                                                                                echo "select sum(bm_transactionamount) as tot from tbl_tablebillmaster  
//                                                                                where bm_status <> 'Cancelled' and bm_credit <> 'Y' and bm_dayclosedate ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $card = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  sum(tab_transactionamount)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tab_status='closed' AND tab_dayclosedate ='".$_SESSION['date']."'";   
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($card,$_SESSION['be_decimal'])?></div>
                                ...
                                <div class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                		<div class="anylst_report_main_head">Credit Sale</div>
                                         <?php                                  $credit=0;
										$sql_menulists="select  sum(c.cd_amount)  as tot from tbl_tablebillmaster b 
                                                                                left join tbl_paymentmode p on b.bm_paymode=p.pym_id 
                                                                                left join tbl_credit_details c on b.bm_billno = c.cd_billno 
                                                                                where  b.bm_credit = 'Y' AND b.bm_dayclosedate ='".$_SESSION['date']."'";
                                                                                $sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $credit = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  sum(c.cd_amount)  as tot from tbl_takeaway_billmaster tb 
                                                                                left join tbl_paymentmode p on tb.tab_paymode=p.pym_id 
                                                                                left join tbl_credit_details c on tb.tab_billno = c.cd_billno
                                                                                where tb.tab_credit = 'y' AND tb.tab_dayclosedate ='".$_SESSION['date']."'";
                                                                                $sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($credit,$_SESSION['be_decimal'])?></div>
                                ...
                                <div style="border-bottom:0;padding-top:5px;" class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                		<div class="anylst_report_main_head">Complimentery</div>
                                         <?php                                  $compliment=0;
										$sql_menulists="select  (sum(bm_finaltotal))  as tot from tbl_tablebillmaster
                                                                                where  bm_status='Closed' AND bm_complimentary='Y' AND bm_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $compliment = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  sum(tab_netamt)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_complimentary = 'y' AND tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($compliment,$_SESSION['be_decimal'])?></div>
                                ...
                                <div style="border-bottom:0;padding-top:5px;" class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                        ...
                                        <?php                                   $tot_bill=0;
										$sql_menulists="select count(bm_billno) as tot from tbl_tablebillmaster 
                                                                                where  bm_status='Closed' AND bm_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $tot_bill = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($tot_bill,$_SESSION['be_decimal'])?></div>
                                ...
                                <div style="border-bottom:0;padding-top:5px;" class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                		<div class="anylst_report_main_head">Bills Cancelled</div>
                                         <?php                                  $bill_cancel = 0;
										$sql_menulists="select count(bm_billno)  as tot from tbl_tablebillmaster  
                                                                                where (bm_status='Cancelled' or bm_status='Cancelled for Split') AND bm_dayclosedate ='".$_SESSION['date']."'"  ;
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $bill_cancel = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_cancelled = 'Y' and tab_dayclosedate ='".$_SESSION['date']."'"  ;
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($bill_cancel,$_SESSION['be_decimal'])?></div>
                                ...
                                <div style="border-bottom:0;padding-top:5px;" class="anylst_report_main">
                                	<div class="anyls_report_center_cc">
                                		<div class="anylst_report_main_head">Item Cancelled</div>
                                         <?php                                  $item_cancel=0;
										$sql_menulists="select count(ch_kot_cancel_id) as tot FROM tbl_tableorder_changes where ch_dayclosedate = '".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $item_cancel = $result_menuss['tot'];   
                                                                                }
//                                                                                $sql_menulists="select  count( tab_billno)  as tot from tbl_takeaway_billmaster 
//                                                                                where tab_status = 'Cancelled' and tab_dayclosedate='".$_SESSION['date']."'";
//										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
//										$num_menuss  = $database->mysqlNumRows($sql_menuss);
//										if($num_menuss){	
//                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
...
//                                                                                }
												?>
                                    	<div class="anylst_report_main_detail"><?=number_format($item_cancel,$_SESSION['be_decimal'])?></div>
							...
							<div style="padding-left:0;" class="widget white">
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                                <li>DI<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                                <?php } } ?>
                                                <?php
										$sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tb.tab_mode='TA' and tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                                <li>TA<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                                <?php } } ?>
                                                <?php
										$sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tb.tab_mode='HD' and tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                                <li>HD<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                                 <?php } } ?>
                                                  <?php
										$sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tb.tab_mode='CS' and tab_dayclosedate ='".$_SESSION['date']."' ";
//                                                                                echo "select  count(tb.tab_billno)  as tot 
//                                                                                from tbl_takeaway_billmaster tb 
//                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tb.tab_mode='CS' and tab_dayclosedate ='".$_SESSION['date']."' ";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                                <li>CS<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                                 <?php } } ?>
                                            </ul>
                                        </div>  
 ...
 WHERE to1.ter_cancel='N' and to1.ter_qty >0 and bm.bm_status='Closed'  and bm.bm_dayclosedate ='".$_SESSION['date']."' GROUP BY sm.ser_staffid ORDER BY amount DESC";
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                                <h2><i><strong><?=$i++;?></strong>. <?=$result_menuss['ser_firstname']?> -<strong><?=number_format($result_menuss['amount'],$_SESSION['be_decimal'])?></strong></i></h2>
                         ...
                         <div class="graph_container" style="height: 38vh;min-height: 36vh;">
                         
                         <div class="widget white no-padding">
								<div style="padding:3% 1% 0 1%" class="earning-widget">
									<div class="earning-graph">
										<h3 style="text-align:left">TOTAL Bills<i></i></h3>
										<span><?=date("F")?></span>
										<div class="full-width"><div id="flot-1ine" style="height:168px"></div></div>
									</div>
                         ...
                         <div class="col-lg-5 col-md-5 col-sm-12 no-padding">
                         	...
                         	<div class="pie_chart_container" style="position:relative">
                                ...
                                <?php                                           $sql_menulists="SELECT (sum(bm_finaltotal))  as tot FROM tbl_tablebillmaster where bm_status='Closed' AND bm_dayclosedate ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										$result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                	$dailytotsale = $result_menuss['tot'];	
                                                                                } 
                                                                                $sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' AND tab_dayclosedate  ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										...
										$result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                	Sale Of The Day - <strong>( <?=number_format($dailytotsale,$_SESSION['be_decimal'])?> )</strong>
									...
									<div class="task-graph">
										<div class="task-graph-chart" style="min-height:195px;">
											<span class="sparkpie" id="pie-task">1,1,2</span>
                                                                                        ...
                                                                                        <i>Total Sales - <strong>Rs. <?=number_format($dailytotsale,$_SESSION['be_decimal'])?></strong></i>
                                            
                                            <?php
										$sql_menulists="select sum(b.bm_totalpax) as tot from  tbl_tablebillmaster b  where bm_status='Closed' and b.bm_dayclosedate ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<i>Total Pax(Din In) - <strong> <?=$result_menuss['tot']?></strong></i>
                                            <?php } } ?>
                                            
                                             <?php
										$sql_menulists="SELECT (sum(B.bm_finaltotal)/sum(b.bm_totalpax)) as avg_rate 
                                                                                FROM tbl_tablebillmaster B where B.bm_status='Closed' AND B.bm_dayclosedate ='".$_SESSION['date']."'";
//                                                                                echo "SELECT ((sum(B.bm_finaltotal))/(sum(b.bm_totalpax))) as avg_rate FROM tbl_tablebillmaster B where B.bm_status='Closed' AND B.bm_dayclosedate ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<i>AVG Rate per person(Din In) - <strong>Rs. <?=number_format($result_menuss['avg_rate'],$_SESSION['be_decimal'])?></strong></i>
                                            <?php } } ?>
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
                                            <i><?=$result_menuss['fr_floorname']?> - <strong>Rs. <?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></strong></i>
                                           <!-- <i>  <strong></strong></i>
                                            <i>  <strong></strong></i>
                                            <i>  <strong></strong></i>
                                            <i>  <strong></strong></i>
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<li>Dine In<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                            <?php } } ?>
                                            
                                            <?php
										$sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' and tab_mode= 'TA' AND tab_dayclosedate  ='".$_SESSION['date']."'";//tab_hd='N'
										...
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<li>Take Away<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                            <?php } } ?>
                                            
                                            <?php
										$sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' and tab_mode= 'HD' AND tab_dayclosedate  ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<li>Home Delivery<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                            <?php } } ?>
                                            
                                            <?php
										$sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' and tab_mode= 'CS' AND tab_dayclosedate  ='".$_SESSION['date']."'";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
										while($result_menuss  = $database->mysqlFetchArray($sql_menuss)) 
												{	
												?>
											<li>Counter Sales<span><?=number_format($result_menuss['tot'],$_SESSION['be_decimal'])?></span></li>
                                            <?php } } ?>
                                ...
                                <div class="left_graphp_detail" style="display: none ">
                                    <div class="col-md-6 no-padding">
										...
										$lstwk_tot = 0;
										$sql_menulists="SELECT (sum(bm_finaltotal)) as tot 
                                                                                FROM tbl_tablebillmaster 
                                                                                where bm_status='Closed' AND bm_dayclosedate  > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss); 
                                                                                    $lstwk_tot = $result_menuss['tot'];
										}
                                                                                $sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' AND tab_dayclosedate  > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss); 
												...
												?>
                                            <h3><?=number_format($lstwk_tot,$_SESSION['be_decimal'])?></h3>
										...
										$sql_menulists="select count(bm_billno) as tot from tbl_tablebillmaster 
                                                                                where  bm_status='Closed' AND bm_dayclosedate > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
//                                                                                echo "select count(bm_billno) as tot from tbl_tablebillmaster 
//                                                                                where  bm_status='Closed' AND bm_dayclosedate > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $lastwk_tot_bill = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tab_dayclosedate > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
//                                                                                echo "select  count(tb.tab_billno)  as tot 
//                                                                                from tbl_takeaway_billmaster tb 
//                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tab_dayclosedate > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 WEEK)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										...
										if($num_menuss){	
												...
												?>
                                            <p>TOTAL : <?=$lastwk_tot_bill?> Bills</p>
                                    ...
                                    <div class="col-md-6 ">
										...
										$sql_menulists="SELECT (sum(bm_finaltotal)) as tot 
                                                                                FROM tbl_tablebillmaster 
                                                                                where bm_status='Closed' AND bm_dayclosedate  > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 MONTH)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss); 
                                                                                    $lstmnth_tot = $result_menuss['tot'];
										}
                                                                                $sql_menulists="select sum( tab_netamt) as tot from tbl_takeaway_billmaster 
                                                                                where  tab_status='closed' and tab_payment_settled = 'Y' AND tab_dayclosedate  > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 MONTH)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss); 
                                                                                ...
                                                                                ?>
                                            <h3><?=number_format($lstmnth_tot,$_SESSION['be_decimal'])?></h3>
                                            <div class="progress">
...
//                                                                                where  bm_status='Closed' AND bm_dayclosedate ='".$_SESSION['date']."' ";
										...
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
                                                                                    $lastmnth_tot_bill = $result_menuss['tot'];
                                                                                }
                                                                                $sql_menulists="select  count(tb.tab_billno)  as tot 
                                                                                from tbl_takeaway_billmaster tb 
                                                                                where tb.tab_status = 'Closed' and tb.tab_payment_settled='Y' and tab_dayclosedate > DATE_SUB('".$_SESSION['date']."', INTERVAL 1 MONTH)";
										$sql_menuss  =  $database->mysqlQuery($sql_menulists); 
										$num_menuss  = $database->mysqlNumRows($sql_menuss);
										if($num_menuss){	
                                                                                    $result_menuss  = $database->mysqlFetchArray($sql_menuss);
												...
												?>
                                            <p>TOTAL : <?=$lastmnth_tot_bill?> Bills</p>
...
<script type="text/javascript">
	  ...
	  data = $(this).serialize() + "&" + $.param(data);//alert(data);
	   $.ajax({
			...
			success: function(data) { 
				...
				width: '200',
				height: '200',
				sliceColors: ['#8878ff','#363b46','#bbbbbb',"#900"]});
				//8878ff blue dine
				//363b46 black ta
				//bbbbbb ash home
	  ...
	  data2 = $(this).serialize() + "&" + $.param(data2);//alert(data);
	   $.ajax({
			...
			success: function(data) { 
				...
				$("#flot-1ine").length && $.plot($("#flot-1ine"), [d0,d00]
				  , 
				  { 
				  series: {
				  lines: {
	...
	$("#flot-1ine").length && $.plot($("#flot-1ine"), [d1,d2]
	, 
	{ 
	series: {
	lines: {
