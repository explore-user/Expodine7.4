    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="loyalty_mgmt_head"><div class="">
                    ...
                    <a   class="inv-req-btn1"  href="store_stock.php">BACK</a>
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">LAST MONTH STORE STOCK HISTORY</a>
...
<div class="inv-req-history" >
 ...
 <input autocomplete="off" onkeyup="search_history();" placeholder="Product" id="search_id" type="text" style="display: none "> 
 
 <input autocomplete="off" disabled value="<?=date('Y-m-01')?>"  onchange="search_history();" placeholder="DATE &nbsp;&nbsp;&nbsp; [Eg: 2022-01-01]" id="datepicker" type="text" style=""> 
  
      <input autocomplete="off" onchange="search_history();" placeholder="To" id="datepicker1" type="text" style="display: none "> 
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
       ...
       var fromdt=$('#datepicker').val();
        var data="set=load_monthly_stock&id=&fromdt="+fromdt+"&todt=&staff=&search_id="
             $.ajax({
        type: "POST",
    ...
    for(w=1;w<=m;w++)
     ...
     var staff=$('#staff').val();
      ...
      var search_id=$('#search_id').val();
              ...
              var data="set=load_monthly_stock&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&search_id="+search_id
 ...
 function search_history(){
   ...
   var staff=$('#staff').val();
    ...
    var search_id=$('#search_id').val();
              ...
              var data="set=load_monthly_stock&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&search_id="+search_id
