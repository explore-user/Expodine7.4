...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_REQUEST['comp1'])   )
{
...
//    }
		...
		$insertion['c_name'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($_REQUEST['comp1']));
                $insertion['c_short_code'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($_REQUEST['comp2']));
              //  $insertion['cor_active'] 		=  mysqli_real_escape_string($database->DatabaseLink,trim($act));
	
         
$sql=$database->check_duplicate_entry('tbl_currency_master',$insertion);
 if($sql!=1)
	{
	$insertid              			=  $database->insert('tbl_currency_master',$insertion);
	}
}	
...
$result=$database->mysqlQuery("UPDATE  tbl_currency_master SET  c_name='" .$_REQUEST['compedit']."',c_short_code='" .$_REQUEST['compedit1']."', c_status='$chck'  where c_id='".$_REQUEST['hideditcomp']."'");
...
<div class="mian">
	<div class="view-container">
		<div style=" top: 58px;"  id="container">
			<div class="breadcrumbs">
				<ul>
					...
					<li><a style="cursor:pointer">Currency Master</a></li>
                ...
                <div class="content-sec">
                    ...
                    <div style="  padding: 2px;" class="col-lg-12 col-md-12 main_cc">
                        <h3 style="background: #fff;margin-bottom: 0;padding: 13px;display: none">CURRENCY MASTER <a style="float:right;border: solid 1px;font-size: 15px;padding: 3px;font-weight: bold;border-radius: 3px " href="currencymaster.php">REFRESH</a></h3>
	 ...
	 ?>
    						<tr >
                                                    <td ><?=$sl++?></td>
                                <td><?=$result_login['c_name']?></td>
                                  <td ><?=$result_login['c_short_code']?></td>
                                
                                <?php if($result_login['c_status']=="Active"){
                                    $sts12="Active";
                                }  else {
                                        $sts12="Inactive";
                                }
                                ?>
                                  ...
                                  <td  >
<!--                                      editclick-->
<a  href="#" class="md-trigger editclick"    rsnid="<?=$result_login['c_id']?>"><img src="images/edit_page.PNG"></a>
			...
			<div class="md-content"  >
				...
				<div>
                    <div class="col-lg-12 col-md-12 no-padding">
                        <form role="form" action="currencymaster.php"  method="post"  name="compform"  >
                        	 ...
                        	 <div class="first_form_contain">
                             	<div class="form_name_cc">Currency Name<span style="color:#F00">*</span></div>
                               	 <div class="form_textbox_cc" id="feedback_div">
                                     <input style="margin-bottom:12px" type="text" class="form-control cancellation" id="comp1" name="comp1" tabindex="1"  placeholder="Name"></div>
                                 </div>
                                  <div class="first_form_contain">
                                     <div class="form_name_cc">Shortcode<span style="color:#F00">*</span></div>
                                      <div class="form_textbox_cc" id="feedback_div">
                                     <input type="text" tabindex="2" class="form-control cancellation" id="comp2" name="comp2"  placeholder="Shortcode"></div>                            	
        ...
        if($("#comp1").val()=="" || $("#comp2").val()=="" )
        {
            ...
            if($("#comp2").val()==""){
                $('.alert_error_popup_all_in_one').show();
                        ...
                        $('.alert_error_popup_all_in_one').text('Enter Shortcut');
                        $('.alert_error_popup_all_in_one').delay(1000).fadeOut('slow');
      
                 document.compform.comp2.focus();
             }
