...
include('includes/master_settings.php');
 ...
 if(isset($_REQUEST['camount'])){
  ...
  if(isset($_REQUEST['setmultinew16'])&&($_REQUEST['setmultinew16']=="multicardnew16")){
     ...
     $_SESSION['billcardbhcs']=$multibilledit16;
...
<!--ESC Key press starts-->
  ...
  $('#selectcreditypes').change(function () {	
            ...
            var sm1=gr1-pd1;
			 ...
			 var labelname=$("#selectcreditypes").find('option:selected').attr('label');
			  ...
			  $.post("load_cs_history.php", {credittype:credittype,set:'loadcreditypes'},
				  function(data)
				  {
 ...
 <input type="hidden" id="whatsapp_api_bill" value="<?=$_SESSION['s_sms_bill']?>"> 
   ...
   <div class="kotcancel_reason_popup_newbhcs" style="display:none">
...
<style>
    ...
    .kotcancel_reason_popup_newbhcs{
	width:370px;
	height:auto;
	position:absolute;
	z-index:99999;
...
.settle_ment_detail_paid_cc{height: 180px;min-height: 29vh;position:relative;}
	 ...
	 var dt=$('#datepicker').val();
	  ...
	  var dateset=res[2] +"-"+ res[1] +"-"+ res[0] ;
		 var billno       =  $('.bill_history_active').attr("billno");
		  ...
		  $.post("load_cs_history.php", {billno:billno,datefield:dateset,value:'loadtahistory_date'},
				  function(data)
				  {
				  	data=$.trim(data);
				  	$('#ta_billlisttotal').html(data);
...
$("#arc_year").change(function () {
          ...
          if( $("#arc_year").val()=='archive'){  
             ...
             $.post("load_cs_history.php", {set_year: 'set_archive'},
                            function (data)
                            {
                                 location.reload();
                            });  
             ...
             $.post("load_cs_history.php", {set_year: 'set_normal'},
                 function (data)
                  {
                       location.reload();
                  });  
...
<div class="container-fluid no-padding">
     <?php //include"includes/topbar.php"; ?>
      ...
      <div style="width:100%" class="top_site_map_cc ">
                ...
                <!--<a href="payment_pending.php"><div class="bill_his_back_btn">Back</div></a>-->
                   ...
                   <div class="bill_history_head" style="font-size: 14px ">Counter Sale Bill History</div>
                
           
                

            <?php ///if(in_array("Take Away", $_SESSION['menumodarray'])){ ?>  
                <a href="<?php if(isset($_SESSION['timeopen']) && !isset($_SESSION['timeclose'])){ ?>counter_sales.php  <?php }else {  ?>#<?php } ?>"><div class="bill_his_back_btn">Back</div></a>
                 <?php //} ?> 
      		...
      		<div style="min-height:480px;width:100%" class="left_contant_container">
                ...
                <div class="left_bill_history_contain">
                    ...
                    <input type="hidden" name="his_mode" id="his_mode" value="CS">
                    <span class="bill_his_fil_nam">Search Date</span>
                    <input value="<?=$today?>" type="text" id="datepicker" name="datepicker" style="color:#333;width:43%;float: left;height: 26px;margin: 2px 0 0 7px;line-height: 27px;border-radius: 4px;border: 0;padding-left: 3px;" readonly onChange="datechange()">
                   <a class="updatestock update_billdetails" style="display:block;left: inherit;right: 0;top: 12px;"></a>
                  </div>
                  
                  <!--<div class="bill_history_flt_cc" style="width: 55%;margin-top: -0.3px;">
                                <span style="width:20%;white-space:nowrap" class="bill_his_fil_nam">Bill - C</span>
                                 <select  style="color:#333;width:38%;float: left;height: 26px;margin: 2px 0 0 1%;line-height: 27px;border-radius: 4px;border: 0;padding-left: 3px;" >
                                 	<option>Select</option>
                                 </select>
                                <input type="text" style="color:#333;width:38%;float: left;height: 26px;margin: 2px 0 0 2%;line-height: 27px;border-radius: 4px;border: 0;padding-left: 3px;" >
                                </div>-->
   ...
   <select id="arc_year"  style="color:#333;width:28%;float: left;height: 26px;margin: 5px 0 0 -6%;line-height: 27px;border-radius: 4px;border: 0;padding-left: 0px;" >
   ...
   <?php } ?>   
                                ...
                                <input style="width:68%" type="text" class="take_away_search_box" placeholder="Bill No" name="search_billno" id="search_billno" onKeyPress="validateSearch()" onKeyDown="validateSearch()" onKeyUp="validateSearch()">
                            Bill No</th>
                            <th width="18%">
                            ...
                            Number</th>
                            <th width="23%">
                            <input type="text" class="take_away_search_box" placeholder="Status" name="search_status" id="search_status" onKeyPress="validateSearch()" onKeyDown="validateSearch()" onKeyUp="validateSearch()">
                            Status</th>
                            <th width="23%">
                                
     <select onchange="validateSearch()" id="paymode_search"  style="color:#333;width:95%;float: left;height: 26px;margin: 2px 0 0 3%;line-height: 27px;border-radius: 4px;border: 0;padding-left: 0px;" >
	...
	if($num_listall){ $i=1;
     ...
     <?php } } ?>
                                ...
                                <span  style="   margin-right: 10px;position: relative;top: 4px;">Paymode</span>  </th>
                        </tr>
                      </table>  
                      <div id="ta_billlisttotal" class="left_detail_scroll">
                		<table class="new_fnt" width="100%"  border="0"> <!----bill_history_active--->
                        <?php    
				$sql_bilhis= "Select tb.tab_paymode,tb.tab_billno,tb.tab_dayclosedate,tb.tab_name,tb.tab_phone, ts.tac_customername,"
                                . " ts.tac_contactno,tb.tab_status  From tbl_takeaway_billmaster as tb LEFT JOIN "
                                . " tbl_takeaway_customer ts ON ts.tac_customerid=tb.tab_hdcustomerid Where "
                                . " tb.tab_dayclosedate ='".$_SESSION['date']."' AND tab_mode = 'CS' AND "
                                . " tb.tab_billno not like 'Temp%' AND tb.tab_billno not like 'HOLD%' ORDER BY "
                                . "  tb.tab_date,tb.tab_time DESC ";
						...
						{$i=1;
                          ...
                          <tr class="ta_bill_history <?php if($result_bilhistory['tab_status']=='Cancelled'){ ?> bill_history_cancel <?php } ?> <?php if($result_bilhistory['tab_billno']==$_REQUEST['bilno']){ ?> bill_history_active <?php } ?>" cur_date="<?=$cur_date?>" billdate="<?= $result_bilhistory['tab_dayclosedate'] ?>" user="<?= $_SESSION['designtnname']?>"  billno="<?=$result_bilhistory['tab_billno']?>" id="<?=$result_bilhistory['tab_billno']?>"  cancelstatus="<?=$result_bilhistory['tab_status']?>"  >
                             ...
                             <td width="14%" style="font-size: 8px;font-weight: bold">
                             <span  class="<?php if($result_bilhistory['tab_status']=='Delivered') { ?> deliverd_1 <?php } else if($result_bilhistory['tab_status']=='Closed') { ?> closed_1 <?php } else if($result_bilhistory['tab_status']=='Packed') { ?> packed_clr <?php } else if($result_bilhistory['tab_status']=='Generated') { ?> genrate_clr <?php }  else if($result_bilhistory['tab_status']=='KOT_Generated') { ?> kot_genrated_clr <?php } else if($result_bilhistory['tab_status']=='Assigned') { ?> assigned_clr <?php } ?>"><?=$result_bilhistory['tab_status']?></span>
                            </td>
        <?php    
        $paymode='';   
	...
	//echo "SELECT * from tbl_takeaway_billdetails as bd LEFT JOIN tbl_menumaster as mn 	ON bd.tab_menuid=mn.mr_menuid LEFT JOIN tbl_portionmaster as pm ON bd.tab_portion=pm.pm_id WHERE bd.tab_billno='".$billno."' order by bd.tab_slno";
	 $sql_listall  =  $database->mysqlQuery("SELECT * from tbl_takeaway_billdetails as bd LEFT JOIN tbl_menumaster as mn 	ON bd.tab_menuid=mn.mr_menuid LEFT JOIN tbl_portionmaster as pm ON bd.tab_portion=pm.pm_id WHERE bd.tab_billno='".$billno."' order by bd.tab_slno "); 
	$num_listall  = $database->mysqlNumRows($sql_listall);
	if($num_listall){$i=1;
		  while($row_listall  = $database->mysqlFetchArray($sql_listall)) 
			  {
                 ...
                 <input type="hidden" value="<?=$row_listall['tab_qty'] ?>" class="tr_clone_add1<?=$row_listall['tab_slno'] ?>">
                    ...
                    <div style="width: 18.5%;font-size: 12px;" class="bil_his_sl_no"><?=$row_listall['pm_portionname'] ?></div>
                ...
                ?>
                   ...
                   <!-- <div class="bill_his_buton_cc">
                     ...
                     <div style="position:relative;background-color:#191919" class="bill_number_head">SETTLEMENT DETAILS
                         ...
                         <div class="pay_change_button changesetledetils" mode="CS" style="height:26px;line-height: 26px;position: absolute">Change</div>
                        ...
                        <tr>
                         ...
                         <?php if( $paymode=="Credit / Debit")
                          ...
                          <tr>
                            ...
                            <span class="bill_story_center_txt"><?=$bm_transactionamount?>/-</span>
                            </td>
...
<?php
		...
		while($result_billhistory  = $database->mysqlFetchArray($sql_billhistory)) 
			{
				...
				$bm_customername =$result_billhistory['tab_customername'];
				$bm_customermobile =$result_billhistory['tab_customermobile'];
    ...
    <?php
                 ...
                 <div id="settlement" class="bill_history_right_detail" style="display:none;position:relative;">
                   ...
                   <div class="bill_number_head">Change Settlement <div style="background-color:transparent;text-align: right;height:23px" class="pay_change_button close_settle"><img src="img/close_ico.png"></div></div>
                    
                	<div class="bill_history_details_table" >
                    
                    	<div class="take_staff_view_cont_cc">
                          <div class="payment_pend_right_cash_head">
                              <div class="payment_pend_right_cash_head_txt"></div>
                              ...
                              <table class="tax_table" width="100%" border="0" cellspacing="5">
                                  <tbody>
                                      <tr>
                                          ...
                                          <td width="5%">:</td>
                                          <td width="50%">
                                              <select style="width:100%;" class="discount_text_box tax_textbox pay_check_cs_new" id="payemntmode_sel" >
                                                  <?php
                ...
                <div style="margin-top:0px;width: 12%;height: 34px;margin-top: -40px;float: right" class="menut_add_bq_btn plusbtn" onclick="return plus();">+</div>     
                              ...
                              <tr >
                                ...
                                <td width="50%"><div class="discount_text_box paymod_text_box trrefresh">
                                       ...
                                       <?php
                                        //$totalcardbill4="";
                                                   $sql_rsnrate4 = "select sum(mc_cardamount) as totamount from tbl_bill_card_payments where (mc_billno = 'temp_".$_SESSION['billcardbhcs']."' or mc_billno = '".$_SESSION['billcardbhcs']."')   ";
                                                              //echo "select sum(mc_cardamount) as totamount from tbl_bill_card_payments where mc_billno = '".$_SESSION['billcard16bhcs']."'";
                                           $sql_rsns1rate4 = $database->mysqlQuery($sql_rsnrate4);
                                                ...
                                                if ($num_rsns1rate4) {
                                                    ...
                                                    //$totalcardbill74="";
                                                    $sql_rsnrate74 = " select tab_netamt from tbl_takeaway_billmaster where tab_billno = '".$_SESSION['billcardbhcs']."'";
                                        ...
                                        <input  placeholder="Enter Transaction Amount" class="tax_textbox transa_txt" value="<?=number_format($totalcardbill4,$_SESSION['be_decimal'])?>" name="transcationid" id="transcationid" onChange="transamountchange()" onkeyup="transamountchange()" onfocus="transamountchange()"   readonly   >
                                    </div></td>
                              </tr>
                              <tr >
                        ...
                        <!--<div class="discount_text_cc crd_head">Cash</div>-->
                    		<table class="tax_table" width="100%" border="0" cellspacing="5">
                             	 <tbody>
                                    ...
                                    <td width="5%">:</td>
                                    <td width="50%"><div class="discount_text_box paymod_text_box">
                                            <input style="width:100%;border: solid 1px #ccc;border-radius: 4px;height:30px"  placeholder="Cash Payment" class=" transa_txt" id="paidamount" name="paidamount" onChange="enterbalance()" onkeyup="enterbalance()" onclick="enterbalance()"  autocomplete="off"  value="0">
                                        </div></td>
                                    </tr>
                                     <tr>
...
<!--        //row start///    -->
            <?php
                                           $sql_rsnrate = "select sum(mc_cardamount) as totamount from tbl_bill_card_payments where (mc_billno = 'temp_".$_SESSION['billcard6bh']."' or mc_billno = '".$_SESSION['billcard6bh']."')   ";
                                          //  echo "select sum(mc_cardamount) as totamount from tbl_bill_card_payments where mc_billno = '".$_SESSION['billcard6']."'";
         ...
         for($i=0;$i<$ct;$i++){
          ?>
        	...
        	<div class="card_detail_popup_list">
                ...
                <div class="card_detail_popup_type" style="width:18%;margin-left:1%">
                    <input type="text" class="card_type_dropdwn amountall"  id="multi_cardamount<?=$i?>"  name="multi_cardamount" onkeypress="return isNumberKey(<?=$i?>)" onkeyup="return addtotalcard()" onclick="return addtotalcard('<?=$i?>')" onchange="return addtotalcard('<?=$i?>')" autocomplete="off" >
                </div>
 ...
 <h3 class="sm_pop_head">Message</h3>
  ...
  <div style="display:none;height: auto;bottom: auto;top: 30%;width:500px;" class="index_popup_2 closeoneclass3">
    ...
    <div class="index_popup_contant" style="margin-top:-6px;height: 40px;">
    	<div style="width: 95px;" class="btn_index_popup"><a href="#" class="closeokcs">Submit</a></div>
...
var date1=$("#datepicker").val();
		...
		data: "value=searchtahistory&billno="+billno+"&name="+name+"&nos="+nos+"&statuss="+statuss+"&date="+new_date+"&paymode="+paymode,
 ...
 $('#kotcancel_reason_popup_new_cancel_btnbh').click(function(){
           $('.kotcancel_reason_popup_newbhcs').css('display','none');
					...
					success: function(msg)
					{
							  ...
							  $('#balanceamout').val('');
								...
								$.post("load_cs_history.php", {billno:billno,value:'load_ta_bildetls'},
								  ...
								  $.post("load_cs_history.php", {billno:billno,value:'load_ta_settlement'},
								  function(data)
								  {
									data=$.trim(data);
                     ...
                     $(".payment_pend_right_cash_error").css("display","block");
			$(".payment_pend_right_cash_error").addClass("popup_validate");
			$(".payment_pend_right_cash_error").text("Insufficient");
			$('.payment_pend_right_cash_error').delay(2000).fadeOut('slow');
                 }
             }
            else{
...
function enterbalance()
	  {       var decimal= $('#decimal').val();
		...
		var grand       =  $('.totalamt').attr("amttot");//alert(grand)
		// var grand=$('#grandtotal').text();
                
               // alert($('.tax_textbox').val());
		if($('.pay_check_cs_new').val()=="1")
		 {
		 	var bal=(parseFloat(paid.replace(/,/g, "")) -  parseFloat(grand.replace(/,/g, ""))).toFixed(decimal);
		 }else if($('.pay_check_cs_new').val()=="2")
		 {
		 	if($('#transbal').val()!="")
			 {
...
$('#kotcancel_reason_popup_new_proceed_btnbh').click(function () {
	...
	$(".changesetledetils").click(function(){
			   ...
			   var paychangeauthcode= $('#authchnage').val();
                           ...
                           if((cancel_key=="Closed" || cancel_key=="Processing") && (amtta=="Credit / Debit" || amtta=="Cash"  || amtta=="Complimentary"  || amtta=="Credit Types" )){
                               
                                $('.kotcancel_reason_popup_newbhcs').css('display','block');
     ...
     function replace_bill_item_click(){
       ...
       if(sts=='Closed'){
         ...
         {  
             ...
             $.post("load_cs_history.php", {billno:bil,value:'load_ta_bildetails'},
				  function(data)
				  {
				  	data=$.trim(data);
				  	 $('#billdetailsset2').html(data);
    ...
    function a4_view(){
       ...
       if(sts=='Closed'){
        ...
        var num=$('#csphone').val(); 
          ...
          window.open('a4_bill_view.php?set=bill_view_ta_hd_cs&billno='+bill+"&mode=COUNTERSALE&num="+num, '_blank');
