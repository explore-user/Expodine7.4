  <style>
  .dropdown-menu{bottom:inherit !important}
  .new_right_drop{position: absolute !important;top:73px;right: 0;}
  .top_menu_active {background-color: rgba(245, 75, 27, 0.36) !important;}
  </style>
  <script type="text/javascript" src="js/bootstrap-3.3.2.min.js"></script>
  <?php $linkname	= basename($_SERVER['PHP_SELF']); ?>
  <div class="backto_table_select back_bill_his new_right_drop" >
                  <?php if($linkname=='ta_bill_history.php'|| $linkname=='ta_customer_history.php'||$linkname=='take_away_list.php' || $linkname=='take_away_kot.php' || $linkname=='take_away_search.php' || $linkname=='payments_ta_cs.php') { ?> 
                    <ul>
                    <li class="dropdown goto_backward_drop">
                      <a class="pusher" href="#"  data-toggle="dropdown"><span></span> <span></span> <span></span></a>
                      <ul class="dropdown-menu right_drop_menu">
					<div class="right_quick_mn_head"><?=$_SESSION['home_menus']?></div>
    
                    <li>
                       
                    <a href="take_away_.php" title="">Home</a>
                   </li>
                
               <?php if(in_array("take_away", $_SESSION['menuarray'])) { ?>
                    <li>
                        <a href="take_away_.php" <?php if($linkname=='ta_bill_history.php'){ ?>class="top_menu_active" <?php } ?> title="">TA - Order</a>
                    </li>
                  <?php } ?>
                    ...
                    <li>
                        <a href="#" onclick="return settlepopupcommonta()" <?php if($linkname=='payments_ta_cs.php'){ ?>class="top_menu_active" <?php } ?> title="">TA - Bill</a>
                    </li>
                    <?php } ?>
                    ...
                    <li>
                        <a href="total_ta_bill_history.php" <?php if($linkname=='total_ta_bill_history.php'){ ?>class="top_menu_active" <?php } ?> title="">TA - Total Bill History</a>
                    </li>
                    <?php } ?>
                    
                    <li>
                        <a href="ta_customer_history.php" <?php if($linkname=='ta_customer_history.php'){ ?>class="top_menu_active" <?php } ?> title="">TA - Customer History</a>
                    </li>
                   
                      </ul>
                    </li>
              </ul>
       <?php } if($linkname=='cs_bill_history.php' || $linkname=='counter_sale_kot.php') { ?>  
					...
					<div class="right_quick_mn_head"><?=$_SESSION['home_menus']?></div>
                       ...
                       <li>
                      <a href="counter_sales.php" title="">Home</a>
                    
                        </li>
                
                    <?php if(in_array("counter_sales", $_SESSION['menuarray'])) { ?>
                    <li>
                        <a href="counter_sales.php" <?php if($linkname=='counter_sales.php'){ ?>class="top_menu_active" <?php } ?> title="">CS - Order</a>
                    </li>
               
                    <?php } ?>
                    <?php if(in_array("counter_sale_kot", $_SESSION['menusubarray'])) { ?>
                    <li>
                        <a href="counter_sale_kot.php" <?php if($linkname=='counter_sale_kot.php'){ ?>class="top_menu_active" <?php } ?> title="" >CS - KOT</a>
                    </li>
                    <?php } ?> 
                     <!--<?php if(in_array("take_away_search", $_SESSION['menusubarray'])) { ?>
                    <li>
                    ...
                    <?php if(in_array("payments_ta_cs", $_SESSION['menusubarray'])) { ?>
                    <li>
                        <a href="#" onclick="return settlepopupcommoncs()" <?php if($linkname=='payments_ta_cs.php'){ ?>class="top_menu_active" <?php } ?> title="">CS - Bill</a>
                    </li>
                    <?php } ?>
                     <?php //if(in_array("take_away_list", $_SESSION['menusubarray'])) { ?>
<!--                    <li>
                        <a href="take_away_list.php" <?php //if($linkname=='take_away_list.php'){ ?>class="top_menu_active" <?php //} ?> title="">CS - Staff Assign</a>
                    </li>-->
                    <?php //} ?>
                     <?php //if(in_array("take_away_staff", $_SESSION['menusubarray'])) { ?>
<!--                    <li>
                        <a href="take_away_staff.php" <?php //if($linkname=='take_away_staff.php'){ ?>class="top_menu_active" <?php //} ?> title="">CS - Staff Bill</a>
                    </li>-->
                    <?php //} ?>
                    
                     <?php if(in_array("cs_bill_history", $_SESSION['menusubarray'])) { ?>
                    <li>
                        <a href="cs_bill_history.php" <?php if($linkname=='cs_bill_history.php'){ ?>class="top_menu_active" <?php } ?> title="">CS - Bill History</a>
                    </li>
                    <?php } ?>
                    
                    <?php if(in_array("total_ta_bill_history", $_SESSION['menusubarray'])) { ?>
                    <li>
                        <a href="total_ta_bill_history.php" <?php if($linkname=='total_ta_bill_history.php'){ ?>class="top_menu_active" <?php } ?> title="">CS - Total Bill History</a>
                    </li>
                    <?php } ?>
                    
<!--                    <li>
                        <a href="ta_customer_history.php" <?php //if($linkname=='ta_customer_history.php'){ ?>class="top_menu_active" <?php //} ?> title="">CS - Customer History</a>
                    </li>-->
