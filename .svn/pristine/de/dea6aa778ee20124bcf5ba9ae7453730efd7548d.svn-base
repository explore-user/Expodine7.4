...
--
-- Host: localhost:3306
-- Generation Time: Aug 26, 2025 at 09:04 AM
...
CREATE TABLE `tbl_cloud_store_transfer` (
  ...
  `tct_rejected_updated` varchar(2) COLLATE utf8mb3_unicode_ci DEFAULT 'N',
  `tct_rejected_updated_on` datetime DEFAULT NULL,
  `tct_partial_option` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `tct_cancel_updated` varchar(1) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'N',
  `tct_cancel_updated_on` datetime DEFAULT NULL,
  `tct_option_remarks` varchar(250) COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_loyalty_reg` (
  ...
  `ly_otp` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tbl_menumaster` (
  ...
  `mr_central_id` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tbl_qr_order_details` (
  ...
  `tq_reorder` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_requisition` (
  ...
  `tr_central_partial` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `tr_partial_option` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `tr_cancel_updated` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
ALTER TABLE `tbl_loyalty_reg`
  ...
  ADD UNIQUE KEY `ly_mobileno` (`ly_mobileno`);
...
ALTER TABLE `tbl_menumaster`
  ADD PRIMARY KEY (`branchid`,`mr_menuid`);
...
ALTER TABLE `tbl_product_conversion`
  ...
  ADD UNIQUE KEY `branchid` (`branchid`,`tpc_id`,`tpc_from_product`);
...
ALTER TABLE `tbl_qr_user_detail`
  ...
  ADD UNIQUE KEY `tu_branchid` (`tu_branchid`,`tu_number`);
...
ALTER TABLE `tbl_requisition`
  ...
  ADD UNIQUE KEY `branchid` (`branchid`,`tr_req_id`,`tr_product`),
  ADD UNIQUE KEY `branchid_2` (`branchid`,`tr_req_id`,`tr_product`);
...
ALTER TABLE `tbl_vendor_master`
  ADD UNIQUE KEY `branchid` (`branchid`,`v_id`);
