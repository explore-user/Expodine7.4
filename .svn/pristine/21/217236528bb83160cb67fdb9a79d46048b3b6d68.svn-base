    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="" >
                 ...
                 <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important; "  class="inv-req-btn1" href="#">WASTAGE ENTRY</a>
                <a class="inv-pro-btn1"  href="wastage_history.php">WH</a>
...
<h6 style="width: 7rem;">Weight</h6>
<h6 style="width: 7rem;">QTY</h6>
<h6 style="width: 10rem;">STOCK</h6>
<h6 style="width: 10rem;">REASON</h6>
...
<div class="inv-req-form" style="padding-left: 0.5rem; padding-right: 0.5rem;">
    ...
    <input style="width: 7rem;" id="weight" onkeyup="valid_weight_qty();" onkeypress="return numdot(this,event);"  placeholder="WEIGHT" type="text">
    
     <input style="width: 7rem;" id="qty" onkeyup="valid_weight_qty();" onkeypress="return numdot(this,event);"  placeholder="QTY" type="text">
    
      <input style="width: 10rem;" readonly  id="current_stock" onkeypress="return numdot(this,event);"  placeholder=" STOCK " type="text">
     
      <select id="reason" style="width: 10rem;">
          
          <option value="Damage">Damage</option>
          <option style="color:darkred;font-weight: bold" value="Wrong_Entry">Wrong Entry</option>
<!--            <option value="Return">Return</option>-->
<!--             <option value="Return">Cancellation</option>-->
...
<div class="inv-req-Submit" style="margin-top:auto;">
  ...
  Items : <span id="rps_count">0</span>
    <?php 
  $store_on='';
   $fnct_menu1 = $database->mysqlQuery("select tw_store from tbl_wastage where tw_set='N' ");
         $num_fdtl1 = $database->mysqlNumRows($fnct_menu1);
        if ($num_fdtl1 > 0) {
              while ($result_fnctvenue1 = $database->mysqlFetchArray($fnct_menu1))
              {
                  $store_on=$result_fnctvenue1['tw_store'];
    ...
    <select  id="store" <?php if($store_on!=''){ ?> style="pointer-events: none "   <?php } ?>>
...
$(document).on('keyup',function(e) {
 ...
 $('.calc').click( function(event) { 
		...
		$('#'+focused).focus();
                 ...
                 var datastring = "set=product_wastsage_load"
                 ...
                 { 
                    ...
                    $('#rps_count').text(sl); 
                    var product=record.tw_name;
                    var  qty=record.tw_qty;
                    
                    if(record.tw_brand=='null' || record.tw_brand=='' || record.tw_brand==null ){
                         var  brand= '';
                    }else{
                      brand=record.tw_brand;
                    }
                    
                    
                    if(record.tw_barcode=='null' || record.tw_barcode=='' || record.tw_barcode==null){
                         var  barcode= '';
                    }else{
                      barcode=record.tw_barcode;
                    }
                    
                     if(record.tw_weight=='null' || record.tw_weight=='' || record.tw_weight==null){
                         var  weight= '';
                    }else{
                      weight=record.tw_weight;
                    } 
                    
                     var  rate_type=record.tw_rate_type;
                     var  unit_type=record.tw_unit_type;
                   ...
                   var  current_stock=record.tw_current_stock;
                   var  reason=record.tw_reason;
                   
              if($('.append_div_main').find('#del_card' + record.tw_id).length === 0) {
                  
              $(".append_div_main").append(" <div class='add_menu_row ' id='second_div_main"+record.tw_id+"' >"+
 "<div class='inv-req-form'>"+
    "<span class='inv-req-sl' style='width: 3%; overflow:hidden;display:none'>"+sl+"</span>"+
    
    "<input   id='product"+record.tw_id+"' value='" + product + "' readonly type='text' style='width: 10rem;'>  "+
   
   " <input id='barcode"+record.tw_id+"' value='" + barcode + "' readonly  type='text' style='width: 10rem;'>"+
   
    "<input value='" + rate_type + "' style='width: 12rem;' readonly id='rate_type"+record.tw_id+"' type='text'>"+
    
    "<input value='" + brand + "'  id='brand"+record.tw_id+"' readonly type='text' style='width: 10rem;'>"+
    
   " <input value='" + unit_type + "'  style='width: 10rem;' id='unit_type"+record.tw_id+"' readonly type='text'>"+
   
    " <input value='" + weight + "'  "+chk_weight +"  onkeyup='valid_weight_qty1("+record.tw_id+");' onkeypress='return numdot(this,event);'    style='width: 7rem;' id='weight"+record.tw_id+"'  type='text'>"+
    
    " <input value='" + qty + "'   "+chk_qty +"   onkeyup='valid_weight_qty1("+record.tw_id+");'  onkeypress='return numdot(this,event);'   style='width: 7rem;' id='qty"+record.tw_id+"'  type='text'>"+
    
     " <input value='" + current_stock + "' readonly style='width: 10rem;' id='current_stock"+record.tw_id+"'  type='text'>"+
    
    "<select id='reason"+record.tw_id+"' style='width: 10rem;'>"+
          
           " <option value='" + reason + "'>"+ reason +"</option>"+
           
         
      "</select> <a title='Qty Update Button' style='margin-left:-39px' onclick='edit_por_qty("+record.tw_id+")'  ><i class='fa fa-check fa-lg' aria-hidden='true' style='color:green;cursor: pointer'></i></a>"+
    
    
    " <a class='inv-req-btn' onclick='delete_req("+record.tw_id+")'  style='width: 3rem;background-image: linear-gradient( 223deg,#cc1d35, #ff3a55)!important;color: #fff;cursor: pointer'>x</a>"+
   ...
   $("#plusbtn").click(function()
        {    
          ...
          var store= $("#store").val();
           ...
           var datastring2 = "set=check_product_wastage&product="+product_id;
       ...
       $("#weight").focus();
        ...
        $('#load_error').delay(1000).fadeOut('slow');        
           ...
           var datastring = "set=add_product_wastage&product="+product+"&barcode="+barcode+"&weight="+weight
                   +"&qty="+qty+"&brand="+brand+"&product_id="+product_id+"&unit_type="+unit_type+"&rate_type="+rate_type+"&edit_id="+edit_id+"&store="+store+"&current_stock="+current_stock+"&reason="+reason;
        
            if(product!='' && qty > '0' && weight >'0' && store!=''   ){
                 ...
                 $('#reason').val('Damage'); 
                    ...
                    $.each(a, function(i, record) {
                         ...
                         $("#second_div_main"+record.tw_id).empty();
                         $("#second_div_main"+record.tw_id).hide();
   ...
   "<input value='" + unit_type + "'  style='width: 10rem;' id='unit_type"+record.tw_id+"' readonly type='text'>"+
    ...
    "<input value='" + qty + "'   "+chk_qty +"  onkeyup='valid_weight_qty1("+record.tw_id+");'  onkeypress='return numdot(this,event);'   style='width: 7rem;' id='qty"+record.tw_id+"'  type='text'>"+
     ...
     "<select id='reason"+record.tw_id+"' style='width: 10rem;'>"+
      ...
      "</select><a title='Qty Update Button' style='margin-left:-45px' onclick='edit_por_qty("+record.tw_id+")'  ><i class='fa fa-check fa-lg' aria-hidden='true' style='color:green;cursor: pointer'></i></a>"+
...
function confirm_yes_new(){
      ...
      var id= $('#confirm_pop_all').attr('edit_id'); 
       ...
       var qty=  $('#qty'+id).val();
          ...
          var data="set=update_wastage_qty&id="+id+"&qty="+qty+"&weight="+weight+"&unit="+unit+"&rate_type="+rate_type;
...
function numdot(item,evt) {
 ...
 function delete_req(id){
     ...
     $('#load_error').show();
        ...
        var data="set=delete_wastage&id="+id;
...
//         var store    =  $('#store').val(); 
//           
//         var data="set=add_wastage_all&store="+store;
//           
//          if(store!='' ){ 
//              
//              $('#load_error1').show();
...
//        }
    ...
    function submit_phy(){
        ...
        var data="set=check_user_wastage&pin="+pin;
...
<div class="inv-password-input"><div class="inv-password-input-icon" ><i class="fa fa-unlock" aria-hidden="true"></i></div>
    <input maxlength="4" onkeypress='return numdot(this,event);' id="pin" type="password"><div style="padding-top:2rem;" class="inv-password-input-icon">
