        ...
        <div class="container-fluid no-padding">
            ...
            <div class="middle_container">
                <div style="width:100%" class="top_site_map_cc ">
                    ...
                    <a title="Home" href="take_away_.php"><div class="backto_table_select" style="float:left;width: 110px">
                   ...
                   <?php } ?>
                    ...
                    <div style="width: 24%;" class="billgeneration_head"><?=$_SESSION['payment_pending_paymentpending']?> - <?=$_SESSION['takeway_ta']?></div>
...
if ($num_ds) {
    ...
    while ($result_ds = $database->mysqlFetchArray($sql_ds)) {
        ?>
    <option  value="<?= $result_ds['pym_code'] ?>" idval="<?= $result_ds['pym_id'] ?>" <?php if ($i == 1) { ?> selected <?php } ?> ><?= $result_ds['pym_name']//$result_ds['pym_name'] ?></option>
    <?php $i++;
    }
    } ?>
                                ...
                                <table class="tax_table" width="100%" border="0" cellspacing="5">
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="50%"><div class="discount_text_box paymod_text_box">
                                                    <input  placeholder="<?=$_SESSION['payment_pending_palceholder_voucher_amount']?>" class="tax_textbox transa_txt" name="vocamount" id="vocamount" readonly   >
                                                </div></td> 
                                        </tr>
                                        <tr>
                                            <td width="45%"><?=$_SESSION['payment_pending_balancepay']?></td>
                                ...
                                <table class="tax_table" width="100%" border="0" cellspacing="5">
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="50%"><div class="discount_text_box paymod_text_box">
                                                    <input  placeholder="<?=$_SESSION['payment_pending_palceholder_cheque_amount']?>" class="tax_textbox transa_txt" name="cheqamount" id="cheqamount" onChange="cheqamountchange()"  autocomplete="off">
                                                </div></td>
                                        </tr>
                                        <tr>
                                ...
                                <table class="tax_table" width="100%" border="0" cellspacing="5">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="5%">:</td>
                                            <td width="50%"><div class="discount_text_box paymod_text_box">
                                                    <input  placeholder="<?=$_SESSION['payment_pending_palceholder_credit_enteramount']?>" class="tax_textbox transa_txt" id="paidamount_credit" name="paidamount_credit" onChange="enterbalance_credit()" onkeyup="enterbalance_credit()" value="0"  autocomplete="off">
                                                </div></td>
                                        </tr>
                                        <tr>
...
if ($num_ds) {
    while ($result_ds = $database->mysqlFetchArray($sql_ds)) {
        ?>    
                                       ...
                                       <option value="<?= $result_ds['ct_creditid'] ?>" label="<?=$result_ds['ct_credit_type']// $result_ds['ct_labels'] ?>"><?=$result_ds['ct_credit_type']// $result_ds['ct_credit_type'] ?></option>
