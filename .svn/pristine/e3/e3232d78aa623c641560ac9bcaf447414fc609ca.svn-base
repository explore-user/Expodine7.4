    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="loyalty_mgmt_head"><div class="">
                    ...
                    <a   class="inv-req-btn1"  href="production.php">BACK</a>
                <a style="font-size: 1.6rem;border-radius: 0.5rem;box-shadow: 0rem 0rem 0rem 0.1rem #fbaea4;color: #000000;background-image: linear-gradient( 223deg, #ffffff, #ffffff)!important;" class="inv-pro-btn1 " href="#">PRODUCTION HISTORY</a>
...
<div class="inv-req-history" >
 ...
 <input autocomplete="off" onkeyup="search_history();" placeholder="Name" id="search_id" type="text" style=""> 
...
<script src="assets/plugins/datatables/dataTables.bootstrap.js"></script>
    ...
    $(document).ready(function () {
        ...
        var data="set=load_production_history&id=&fromdt=&todt=&staff=&search_id="
             $.ajax({
        type: "POST",
    ...
    function pagination(p,q)
 {
    ...
    for(w=1;w<=m;w++)
     ...
     var staff=$('#staff').val();
      ...
      var search_id=$('#search_id').val();
              ...
              var data="set=load_production_history&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&pagination="+p+"&recordcount="+recordcount+"&staff="+staff+"&search_id="+search_id
    ...
    function phy_items(id){
        ...
        $('.item_pop').show();
         ...
         var data="set=load_transfer_consum_items&id="+id
 ...
 function search_history(){
   ...
   var staff=$('#staff').val();
    ...
    var search_id=$('#search_id').val();
              ...
              var data="set=load_production_history&id="+id+"&type="+type+"&fromdt="+fromdt+"&todt="+todt+"&staff="+staff+"&search_id="+search_id
