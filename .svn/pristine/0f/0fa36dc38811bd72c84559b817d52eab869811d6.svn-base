...
function print_page()
{
 ...
 $("#datepickerfromsales").datepicker({
	...
	/*******************************************type  of sales change starts**********************************************/
        ...
        var del_typ=$('#del_typ').val();
                
						$.post("load_hdreport.php", {fromdt:fromval,todt:tot_to,type:typeval,typesale:typesale,staffsel:staffsel,bydate:bydate,del_typ:del_typ,sale:"sl"},
						function(data)
						{                                                   
							  data=$.trim(data);
							  $('#reportload').html(data);
        ...
        var sortby=$('#bill_sort').val();
						...
						$.post("load_hdreport.php", {fromdt:fromval,todt:tot_to,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,del_typ:del_typ,set:"ft"},
						function(data)
						{
							  data=$.trim(data);
							  $('#reportload').html(data);
	...
	$('#datepickertodtsales').change(function () {
		...
		if(tot_from=="")
		{
			tot_from="";
						...
						$.post("load_hdreport.php", {fromdt:tot_from,todt:tot_to,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,addon:addon,sortby:sortby,del_typ:del_typ,set:"ft"},
						function(data)
						{
							  data=$.trim(data);
	...
	$('#bydatesales').change(function () 
	{
        ...
        var sortby=$('#bill_sort').val();
	 	...
	 	$('#datepickertodtsales').val("");
						...
						$.post("load_hdreport.php", {bydate:bydate,type:typeval,typesale:typesale,staffsel:staffsel,loginstaffsel:loginstaffsel,fromdt:'',todt:'',addon:addon,sortby:sortby,del_typ:del_typ,abc:"ft"},
						function(data)
						{
							data=$.trim(data);
							$('#reportload').html(data);
		...
		var bydate=$('#bydatesales').val();
						...
						$.post("load_hdreport.php", {fromdt:fromval,todt:tot_to,sortby:sortby,bydate:bydate,type:typeval,sortby:sortby,set:"ft"},
						function(data)
						{
							  data=$.trim(data);
							  $('#reportload').html(data);
		...
		$('#ui-datepicker-div').css("display", "none");
                ...
                var addon=$(this).val();
						...
						$.post("load_hdreport.php", {type:typeval,fromdt:fromval,todt:tot_to,bydate:bydate,addon:addon},
						function(data)
						{
							  data=$.trim(data);
							  $('#reportload').html(data);
...
<body>
 ...
 <div  class="sitemap_cc">Home Delivery Report</div>
  <div id="container">  
                                ...
                                <div class="text-selection_name">Type</div>
                                   <div class="input-group" style="width: 84%;">
                                         <select  class="form-control add_new_dropdown_report" onChange="reportcreate(this.value)" name="typeval" id="typeval">
                                           ...
                                           <?php  
                                         $sql_login  =  $database->mysqlQuery("select rm_reportid,rm_printa4,rm_posprintofanother,rm_reportname from tbl_reportmaster where rm_reportview='Y' and rm_reporttype='HD'"); 
                             ...
                             <!-- type of sales starts -->                     
                                  ...
                                  <div id="stfsel">
                                   ...
                                   <div class="search_name_box_main">
                                    <div class="text-selection_name">Type:</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" name="del_typ" id="del_typ">
                                              <option value="D" >Delivered</option>
                                              
                                              <option value="P" >Assigned</option>
                                    ...
                                    <div class="text-selection_name">Login Staff:</div>
                                     <div class="input-group">
                                         <select  class="form-control add_new_dropdown_report" name="loginstaffsel" id="loginstaffsel">
                                            ...
                                            WHERE  tab_status='cancelled' AND tab_mode= 'HD' order by tab_cancelledlogin asc"); 
...
{
	var repttype=rpt;
	if(repttype=="tot_sales_hd")
	{
        $('#del_typ1').css("display", "none");
        ...
        $('#bill_sort_div').css("display", "none");
				  ...
				  $.post("load_hdreport.php", {type:repttype,fromdt:'',todt:'',bydate:''},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
	...
	else if(repttype=="billreport_hd")
	{
        $('#del_typ1').css("display", "none");
        $('#type_salesdiv').css("display", "block");
        $('#stfsel').css("display", "none");
        ...
        var sortby= $('#bill_sort').val();
				...
				$.post("load_hdreport.php", {type:repttype,fromdt:'',todt:'',bydate:'',sortby:sortby},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
    ...
    else if(repttype=="delivery_report_hd")
	{
        $('#del_typ1').css("display", "block");
        $('#type_salesdiv').css("display", "block");
        $('#stfsel').css("display", "block");
		$('#totalsalesdiv').css("display", "none");
        $('#loginstf').css("display", "none");
        $('#discountsalesdiv').css("display", "none");
		$('#totalpaydiv').css("display", "none");
        ...
        var sortby= $('#bill_sort').val();
			...
			$.post("load_hdreport.php", {type:repttype,fromdt:'',todt:'',bydate:'',sortby:sortby,del_typ:del_typ},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
        ...
        else if(repttype=="categorywise_report_hd")
	{
        $('#del_typ1').css("display", "none");
        $('#type_salesdiv').css("display", "block");
        $('#stfsel').css("display", "none");
    ...
    else if(repttype=="total_summary_details_hd")
	{
        $('#del_typ1').css("display", "none");
        $('#type_salesdiv').css("display", "block");
        $('#stfsel').css("display", "none");
	...
	else if(repttype=="cancel_history_hd")
	{
    ...
    else if(repttype=="order_hd")
	{
        ...
        $('#bill_sort_div').css("display", "none");
				...
				$.post("load_hdreport.php", {type:repttype,fromdt:'',todt:'',bydate:'',addon:''},
				  function(data)
				  {
						data=$.trim(data);
						$('#reportload').html(data);
...
function movetoexcelForm()
{
	...
	if(check==true)
	{
                ...
                else if(vv=="delivery_report_hd")
		{
			...
			window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&del_typ="+del_typ;					  
		}
        else if(vv=="billreport_hd")
		{
        ...
        else if(vv=="order_hd")
		{
            ...
            var tot_to=$('#datepickertodtsales').val();
			var hidbydate=$('#bydatesales').val();
            var byflr=$('#floorsel23').val();
            var staffsel = $('#staffsel').val();
			var addon=$('#menu_type').val();
			
				window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&addon="+addon;				
		}
        else if(vv=="categorywise_report_hd")
		{
			var tot_from=$('#datepickerfromsales').val();
            var tot_to=$('#datepickertodtsales').val();
			var hidbydate=$('#bydatesales').val();
        ...
        else if(vv=="total_summary_details_hd")
		{
			var staffsel = $('#staffsel').val();
			var tot_from=$('#datepickerfromsales').val();
            var tot_to=$('#datepickertodtsales').val();
        ...
        else if(vv=="cancel_history_hd")
		{
			var loginstf = $('#loginstaffsel').val();
            var tot_from=$('#datepickerfromsales').val();
    		var tot_to=$('#datepickertodtsales').val();
            var typesale=$('#typesale').val();
            var hidbydate=$('#bydatesales').val();
            var a4paper=$('#hida4settings').val();
				...
				window.location="taexcel_download.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+loginstf;				
		}
	}
}
	 ...
	 ofprint = $('#typeval').find('option:selected').attr('printof');
            ...
            var a4paper=$('#hida4settings').val();
                ...
                if(printera4=="N"){
					window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"#print",'_blank');
                        ...
                        $.post("hd_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,staffsel:staffsel},
                            function(data)
                            {
                            data=$.trim(data);
                             data=data.split('**');
        ...
        else if(vv=="delivery_report_hd")
		{
            ...
            var del_typ=$('#del_typ').val();
                ...
                if(printera4=="N"){
				window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&del_typ="+del_typ+"#print",'_blank');				
                }else{
            	$.post("hd_print_report.php", {type:vv,fromdt:tot_from,todt:tot_to,hidbydate:hidbydate,staffsel:staffsel,del_typ:del_typ},
                            function(data)
                            {
                            data=$.trim(data);
                            data=data.split('**');
        ...
        var a4paper=$('#hida4settings').val();
     	if(printera4=="N"){
            ...
            $.post("hd_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate},
                function(data)
                {
                data=$.trim(data);
                data=data.split('**');
		...
		{                 
                ...
                if(printera4=="N"){
					window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+loginstf+"#print",'_blank');				
                     }else{
                    $.post("hd_print_report.php", {type:vv,hidfr:tot_from,hidto:tot_to,hidbydate:hidbydate,cncl:'cncl',loginstf:loginstf},
                    function(data)
                    {
                    data=$.trim(data);
                    data=data.split('**');
		...
		{ 
			...
			if(printera4=="N")
					{
				window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"&addon="+addon+"#print",'_blank');
					}
					else					
					{
						$.post("hd_print_report.php", {type:vv,from:tot_from,to:tot_to,hidbydate:hidbydate,staffsel:staffsel,typesale:typesale,addon:addon},
		...
		{ 
			...
			if(printera4=="N")
				...
				window.open("taprint_bill.php?type="+vv+"&fromdt="+tot_from+"&todt="+tot_to+"&bydate="+hidbydate+"&staffsel="+staffsel+"#print",'_blank');
					...
					{
						$.post("hd_print_report.php", {type:vv,from:tot_from,to:tot_to,hidbydate:hidbydate,staffsel:staffsel,typesale:typesale},
						  function(data)
						  {
						  data=$.trim(data);
                          data=data.split('**');
